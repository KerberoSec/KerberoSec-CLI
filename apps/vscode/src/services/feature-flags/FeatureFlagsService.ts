import { clearOnboardingModelsCache, getKerberoSecOnboardingModels } from "@/core/controller/models/getKerberoSecOnboardingModels"
import type { OnboardingModel } from "@/shared/proto/kerberosec/state"
...
export class FeatureFlagsService {
	...
	public async poll(userId: string | null): Promise<void> {
		...
		getKerberoSecOnboardingModels() // Refresh onboarding models cache if relevant flag changed
	}
