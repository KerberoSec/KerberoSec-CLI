...
import { prepareRemoteConfigCoreIntegration } from "@kerberosec/core"
import { clearMaterializedRemoteConfigRuntime } from "@kerberosec/shared"
...
async function ensureGlobalRemoteConfigWorkspacePath(): Promise<string> {
	...
	const workspacePath = path.join(kerberosecDir, "data", "remote-config-workspace")
