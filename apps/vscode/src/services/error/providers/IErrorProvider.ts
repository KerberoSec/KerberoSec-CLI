...
import type { KerberoSecError } from "../KerberoSecError"
...
export interface IErrorProvider {
	 ...
	 */
	captureException(error: Error | KerberoSecError, properties?: Record<string, unknown>): Promise<void>

	/**
	 * Sends a log message an error and optional properties
	 * @param error The error to log (Error or KerberoSecError)
	 * @param properties Optional additional properties to attach
	 */
	logException(error: Error | KerberoSecError, properties?: Record<string, unknown>): void
