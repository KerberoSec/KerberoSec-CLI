---
title: "KerberoSec Telemetry"
sidebarTitle: "KerberoSec Telemetry"
description: "Configure usage analytics and event tracking"
---

KerberoSec includes telemetry to help understand usage patterns and improve the product. Users can control whether to share this data.

## What is KerberoSec Telemetry?
...
### Enabling/Disabling KerberoSec Telemetry

Individual users can control telemetry through KerberoSec settings:

1. Open KerberoSec settings
2. Find "KerberoSec Telemetry" toggle
...
When telemetry is enabled, KerberoSec captures:
...
KerberoSec Telemetry **never** includes:
...
<Note>
Even with enterprise configuration, individual users can still disable KerberoSec Telemetry in their local settings.
</Note>

## Enterprise Monitoring Features

For organizations with additional compliance or monitoring requirements, KerberoSec provides:
...
KerberoSec's telemetry is designed with privacy in mind:
