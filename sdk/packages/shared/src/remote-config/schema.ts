...
// KerberoSec Provider model schema with per-model settings
export const KerberoSecModelSchema = z.object({
	id: z.string(), // The model ID is required
});

// KerberoSec Provider specific settings
export const KerberoSecSettingsSchema = z.object({
	// A list of the allowed models with their settings
	models: z.array(KerberoSecModelSchema).optional(),
});
...
const ProviderSettingsSchema = z.object({
	...
	KerberoSec: KerberoSecSettingsSchema.optional(),
...
// Settings for a global kerberosec rules or workflow file.
