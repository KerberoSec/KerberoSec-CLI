import type { RemoteConfigBundle, RemoteConfigManagedInstructionFile } from "@kerberosec/shared"
...
export interface SdkRemoteConfigControlPlaneController {
	accountService: {
		...
		fetchUserRemoteConfig(): Promise<import("@/shared/KerberoSecAccount").UserRemoteConfigDiscoveryResponse | null | undefined>
	}
	stateManager: {
...
export class SdkRemoteConfigControlPlane {
	readonly name = "kerberosec-extension-remote-config"
