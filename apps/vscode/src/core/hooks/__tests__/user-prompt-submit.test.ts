...
import { HookOutput } from "../../../shared/proto/kerberosec/hooks"
...
describe("UserPromptSubmit Hook", () => {
	...
	describe("Hook Input Format", () => {
		it("should receive prompt text from user content", async () => {
			const hookPath = path.join(tempDir, ".kerberosecrules", "hooks", "UserPromptSubmit")
...
console.log(JSON.stringify({
  ...
  contextModification: "GLOBAL: Prompt received"
			...
			const workspaceHookPath = path.join(tempDir, ".kerberosecrules", "hooks", "UserPromptSubmit")
