import { EmptyRequest } from "@shared/proto/index.kerberosec"
			...
			<BaseRemoteConfigSection renderSectionHeader={renderSectionHeader}>
				<div className="flex flex-col justify-center gap-4">
					<h3>
						...
						<VSCodeLink href="https://app.kerberosec.bot/dashboard/organization?tab=settings">dashboard</VSCodeLink>.
					</h3>
