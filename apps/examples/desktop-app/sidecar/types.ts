...
export type SidecarContext = {
	...
	sessionManager: KerberoSecCore | null;
...
export const SIDECAR_PORT = Number(process.env.KERBEROSEC_SIDECAR_PORT) || 3126;
// Loopback-only by default. Set KERBEROSEC_SIDECAR_HOST=0.0.0.0 to accept
// connections from outside the local host (e.g. Docker port publishing).
export const SIDECAR_HOST =
	process.env.KERBEROSEC_SIDECAR_HOST?.trim() || "127.0.0.1";
