import { UpdateTerminalConnectionTimeoutResponse } from "@shared/proto/index.kerberosec"
				...
				<div className="mb-5" id="terminal-settings-section">
					{isVsCodePlatform && (
						<div className="mb-4">
							...
							<p className="text-xs text-[var(--vscode-descriptionForeground)] mt-1">
								Choose whether KerberoSec runs commands in the VS Code terminal or a background process.
							</p>
						</div>
					)}
						...
						<>
							<div className="mb-4">
								...
								<p className="text-xs text-(--vscode-descriptionForeground)">
									Set how long KerberoSec waits for shell integration to activate before executing commands. Increase
							...
							<div className="mb-4">
								...
								<p className="text-xs text-(--vscode-descriptionForeground)">
									When enabled, KerberoSec will reuse existing terminal windows that aren't in the current working
					...
					<div className="mb-4">
						...
						<p className="text-xs text-(--vscode-descriptionForeground) mt-1">
							Select the default terminal KerberoSec will use. 'Default' uses your VSCode global setting.
						</p>
					</div>
