...
//   - buildSessionConfig() in kerberosec-session-factory.ts (main task loop, which
//     hands a CoreSessionConfig.providerConfig to KerberoSecCore)
//
...
import type { ProviderSettings } from "@kerberosec/core"
import type { ProviderConfig } from "@kerberosec/llms"
