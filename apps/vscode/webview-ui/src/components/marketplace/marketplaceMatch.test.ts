import type { MarketplaceEntry, MarketplaceLocalInstalledEntry } from "@shared/proto/kerberosec/marketplace"
	...
	it("does not match unrelated installed skills through shared path segments", () => {
		...
		const installed = [
			...
			localSkill({
				id: "kerberosec-sdk",
				name: "kerberosec-sdk",
				path: "/home/tester/.agents/skills/kerberosec-sdk/SKILL.md",
			}),
		]
