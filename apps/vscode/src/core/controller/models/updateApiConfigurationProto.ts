...
import type { UpdateApiConfigurationRequest } from "@shared/proto/kerberosec/models"
...
export async function updateApiConfigurationProto(
	...
	try {
		...
		clearOrganizationForKerberoSecPassProviderSelection(controller, normalizedApiConfiguration)
