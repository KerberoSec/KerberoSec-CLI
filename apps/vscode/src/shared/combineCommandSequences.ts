...
/**
 * Combines sequences of command and command_output messages in an array of KerberoSecMessages.
 *
 * This function processes an array of KerberoSecMessages objects, looking for sequences
 ...
 * their text contents.
 *
 * @param messages - An array of KerberoSecMessage objects to process.
 * @returns A new array of KerberoSecMessage objects with command sequences combined.
 *
 * @example
 ...
 */
export function combineCommandSequences(messages: KerberoSecMessage[]): KerberoSecMessage[] {
	const combinedCommands: KerberoSecMessage[] = []
