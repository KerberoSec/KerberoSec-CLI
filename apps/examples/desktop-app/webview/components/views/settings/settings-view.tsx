import { providerOffersModelTool } from "@kerberosec/llms/browser";
 ...
 * light-mode primary (see the [data-kerberosec-accent] blocks in globals.css);
			...
			<section className="max-w-344">
				...
				<div className="flex items-center justify-between gap-5 border-b py-4 max-[720px]:flex-col max-[720px]:items-stretch">
					<div className="flex flex-col gap-1">
						...
						<p className="text-sm text-muted-foreground">
							Pick the icon KerberoSec shows in the Dock.
						</p>
						{appIconError ? (
				...
				<div className="flex py-4 items-center justify-between gap-5 border-b max-[720px]:flex-col max-[720px]:items-stretch max-[720px]:py-4">
					<div className="flex flex-col gap-1">
						...
						<p className="text-sm text-muted-foreground">
							Automatically update the kerberosec terminal command, which shares
				...
				<div className="flex py-4 items-center justify-between gap-5 border-b max-[720px]:flex-col max-[720px]:items-stretch max-[720px]:py-4">
					<div className="flex flex-col gap-1">
						...
						<p className="text-sm text-muted-foreground">
							Enable error and usage reports to help improve KerberoSec.
						</p>
						{telemetryError ? (
							<p className="mt-2 text-xs text-destructive" role="alert">
				...
				<div className="flex py-4 items-center justify-between gap-5 border-b max-[720px]:flex-col max-[720px]:items-stretch max-[720px]:py-4">
					<div className="flex flex-col gap-1">
						...
						<p className="text-sm text-muted-foreground">
							Replay the first-run experience new users see when they open
							KerberoSec for the first time.
						</p>
					</div>
					<Button
						className="shrink-0"
