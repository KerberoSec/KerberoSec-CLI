 ...
 * that data to the shared file-backed stores in ~/.kerberosec/data/ so all platforms
 ...
 *   globalStorageFsPath is still the VSCode-managed path (not ~/.kerberosec/data/),
 ...
 *   to ~/.kerberosec/data/ so that tasks created in VSCode are visible in CLI/JetBrains
