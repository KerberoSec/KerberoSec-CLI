...
//   protoc               v3.19.1
// source: kerberosec/oca_account.proto
...
export const OcaAccountServiceDefinition = {
  ...
  fullName: "kerberosec.OcaAccountService",
  methods: {
    /**
...
export const OcaAccountServiceService = {
   ...
   */
  ocaAccountLoginClicked: {
    path: "/kerberosec.OcaAccountService/ocaAccountLoginClicked" as const,
   ...
   */
  ocaAccountLogoutClicked: {
    path: "/kerberosec.OcaAccountService/ocaAccountLogoutClicked" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
  ...
  /** Subscribe to auth status update events (when authentication state changes) */
  ocaSubscribeToAuthStatusUpdate: {
    path: "/kerberosec.OcaAccountService/ocaSubscribeToAuthStatusUpdate" as const,
    requestStream: false as const,
