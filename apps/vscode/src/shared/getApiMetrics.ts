...
/**
 * Calculates API metrics from an array of KerberoSecMessages.
 *
 ...
 */
export function getApiMetrics(messages: KerberoSecMessage[]): ApiMetrics {
 ...
 */
export function getLastApiReqTotalTokens(messages: KerberoSecMessage[]): number {
