...
import type { KerberoSecAPI } from "../exports/kerberosec"
import { setVscodeHostProviderMock } from "./host-provider-test-utils"

describe("KerberoSecAPI Core Functionality", () => {
	let api: KerberoSecAPI
	...
	beforeEach(async () => {
		...
		// Create a mock controller that matches what the real createKerberoSecAPI expects
		...
		// Create API instance
		api = createKerberoSecAPI(mockController)
	})
