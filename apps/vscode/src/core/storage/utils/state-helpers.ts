...
import type { KerberoSecFileStorage } from "@shared/storage/KerberoSecFileStorage"
import {
	applyTransform,
...
import { KerberoSecMemento } from "@/shared/storage"
import { StateManager } from "../StateManager"

// ─── File-backed storage readers (used by StateManager) ────────────────────

/**
 * Read secrets from a KerberoSecFileStorage instance.
 */
export function readSecretsFromStorage(store: KerberoSecFileStorage<string>): Secrets {
...
/**
 * Read workspace state from a KerberoSecFileStorage instance.
 */
export function readWorkspaceStateFromStorage(store: KerberoSecFileStorage): LocalState {
...
/**
 * Read global state from a KerberoSecFileStorage instance.
 */
export async function readGlobalStateFromStorage(store: KerberoSecMemento): Promise<GlobalStateAndSettings> {
	try {
