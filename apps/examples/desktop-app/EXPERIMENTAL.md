...
branch, shipped to users as **KerberoSec Beta**, and graduated into `main`.
...
([`.kerberosec/skills/publish-desktop/SKILL.md`](../../../.kerberosec/skills/publish-desktop/SKILL.md));
...
- Product name `KerberoSec Beta`, bundle identifier `bot.kerberosec.app.beta`
  (stable is `KerberoSec` / `bot.kerberosec.app`) — set by
...
- Both apps share `~/.kerberosec` (provider credentials, global settings, hub
