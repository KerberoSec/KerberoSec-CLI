...
if (
	palette.includes("--kerberosec-") ||
	tokens.includes("--kerberosec-") ||
	theme.includes("--kerberosec-") ||
	base.includes("--kerberosec-")
) {
	throw new Error("theme contract must not expose --kerberosec-* variables");
}
if (
...
if (
	!tokensWithoutComments.includes('@import "@kerberosec/ui/theme/palette.css";')
) {
...
if (
	...
	!componentTheme.includes("@custom-variant kerberosec-ui-dark") ||
...
if (
	!index.includes('@import "@kerberosec/ui/theme/tokens.css";') ||
	!index.includes('@import "@kerberosec/ui/theme/theme.css";') ||
	!index.includes('@import "@kerberosec/ui/theme/base.css";')
) {
...
console.log("@kerberosec/ui theme contract is valid");
