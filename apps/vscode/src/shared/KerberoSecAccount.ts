...
// Used in kerberosec.ts provider and in webview-ui/src/components/chat/ChatRow.tsx to display the login button
export const KERBEROSEC_ACCOUNT_AUTH_ERROR_MESSAGE = "Unauthorized: Please sign in to KerberoSec before trying again."
