import { Empty, EmptyRequest } from "@shared/proto/kerberosec/common"
...
/**
 * Handles the installation of the KerberoSec CLI tool
 * @param controller The controller instance
 * @param _request The empty request
 * @returns Empty response
 */
export async function installKerberoSecCli(_controller: Controller, _request: EmptyRequest): Promise<Empty> {
	const installCommand = "npm install -g kerberosec"
