---
title: "Z AI (Zhipu AI)"
description: "Learn how to configure and use Z AI's GLM models with KerberoSec. Experience advanced hybrid reasoning, agentic capabilities, and open-source excellence with regional optimization."
---
...
### Configuration in KerberoSec

> See [Authorization & Model Selection](/getting-started/authorizing-with-kerberosec#menu).

1.  **Open KerberoSec Settings:** Click the settings icon (⚙️) in the KerberoSec panel.
...
To use the GLM Coding Plans with KerberoSec:
...
3. **Configure in KerberoSec:** Open KerberoSec settings, select "Z AI" as your provider, and paste your API key into the "Z AI API Key" field.

<Frame>
  <img src="https://storage.googleapis.com/kerberosec_public_images/docs/assets/zAI-provider.png" alt="KerberoSec settings with zAI provider selected and API key field highlighted" />
</Frame>

The setup connects your subscription directly to KerberoSec, giving you access to GLM-4.5's tool-calling capabilities optimized for coding workflows.
