 ...
 *  1. "Nested transport" format written by the KerberoSec CLI (`kerberosec mcp add`)
...
describe("McpSettingsSchema", () => {
	// -------------------------------------------------------------------------
	// Nested transport format (written by the KerberoSec CLI)
	// -------------------------------------------------------------------------
	...
	describe("nested transport format (CLI-authored)", () => {
		...
		it("preserves metadata field from CLI-authored nested format", () => {
			const metadata = { addedBy: "kerberosec-cli", version: "1.2.3" }
			const input = {
				mcpServers: {
					myServer: {
