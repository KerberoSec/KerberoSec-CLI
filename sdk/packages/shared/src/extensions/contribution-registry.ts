...
export interface PluginSetupContext {
	...
	/** Host/client identity such as `kerberosec-cli`, `kerberosec-vscode`, or an SDK app. */
	...
	/**
	 * Automation ingress made available by hosts that enable KerberoSecCore
 ...
 * (e.g. `AgentExtension` in `@kerberosec/agents`) narrow them to the correct
...
> {
	...
	disabled?: boolean;
	/** Runtime-native hooks consumed directly by `@kerberosec/agents`. */
