...
export const TaskResponse: MessageFns<TaskResponse> = {
  encode(message: TaskResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.isLegacy !== false) {
      writer.uint32(96).bool(message.isLegacy);
    }
    return writer;
  },
  ...
  fromJSON(object: any): TaskResponse {
    return {
      ...
      isLegacy: isSet(object.isLegacy)
        ...
        : isSet(object.is_legacy)
        ? globalThis.Boolean(object.is_legacy)
        : false,
    };
  },
...
export const TaskItem: MessageFns<TaskItem> = {
  encode(message: TaskItem, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.apiProvider !== "") {
      writer.uint32(106).string(message.apiProvider);
    }
    return writer;
  },
  ...
  fromJSON(object: any): TaskItem {
    return {
      ...
      isLegacy: isSet(object.isLegacy)
        ...
        ? globalThis.Boolean(object.is_legacy)
        : false,
      apiProvider: isSet(object.apiProvider)
        ? globalThis.String(object.apiProvider)
        : isSet(object.api_provider)
        ? globalThis.String(object.api_provider)
        : "",
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<TaskItem>, I>>(object: I): TaskItem {
    ...
    message.modelId = object.modelId ?? "";
    message.isLegacy = object.isLegacy ?? false;
    message.apiProvider = object.apiProvider ?? "";
    return message;
  },
};
...
export const TaskServiceDefinition = {
  name: "TaskService",
  fullName: "kerberosec.TaskService",
  methods: {
    ...
    proceedWhileRunningCommand: {
      name: "proceedWhileRunningCommand",
      requestType: EmptyRequest as typeof EmptyRequest,
      requestStream: false,
      responseType: Empty as typeof Empty,
      responseStream: false,
...
export const TaskServiceService = {
  /** Cancels the currently running task */
  cancelTask: {
    path: "/kerberosec.TaskService/cancelTask" as const,
  ...
  /** Cancels a queued prompt by ID */
  cancelQueuedPrompt: {
    path: "/kerberosec.TaskService/cancelQueuedPrompt" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Cancels the currently running background command */
  cancelBackgroundCommand: {
    path: "/kerberosec.TaskService/cancelBackgroundCommand" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
   ...
   */
  proceedWhileRunningCommand: {
    path: "/kerberosec.TaskService/proceedWhileRunningCommand" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
  ...
  /** Clears the current task */
  clearTask: {
    path: "/kerberosec.TaskService/clearTask" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
  ...
  /** Gets the total size of all tasks */
  getTotalTasksSize: {
    path: "/kerberosec.TaskService/getTotalTasksSize" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
  ...
  /** Deletes multiple tasks with the given IDs */
  deleteTasksWithIds: {
    path: "/kerberosec.TaskService/deleteTasksWithIds" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Creates a new task with the given text and optional images */
  newTask: {
    path: "/kerberosec.TaskService/newTask" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Shows a task with the specified ID */
  showTaskWithId: {
    path: "/kerberosec.TaskService/showTaskWithId" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: StringRequest): Buffer => Buffer.from(StringRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): StringRequest => StringRequest.decode(value),
  ...
  /** Opens the on-disk session directory (messages json, logs) for the task with the given ID */
  exportTaskWithId: {
    path: "/kerberosec.TaskService/exportTaskWithId" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: StringRequest): Buffer => Buffer.from(StringRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): StringRequest => StringRequest.decode(value),
  ...
  /** Toggles the favorite status of a task */
  toggleTaskFavorite: {
    path: "/kerberosec.TaskService/toggleTaskFavorite" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Gets filtered task history */
  getTaskHistory: {
    path: "/kerberosec.TaskService/getTaskHistory" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Sends a response to a previous ask operation */
  askResponse: {
    path: "/kerberosec.TaskService/askResponse" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Edits a previous user message, truncates following conversation, and regenerates */
  editMessageAndRegenerate: {
    path: "/kerberosec.TaskService/editMessageAndRegenerate" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Records task feedback (thumbs up/down) */
  taskFeedback: {
    path: "/kerberosec.TaskService/taskFeedback" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: StringRequest): Buffer => Buffer.from(StringRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): StringRequest => StringRequest.decode(value),
  ...
  /** Executes a quick win task with command and title */
  executeQuickWin: {
    path: "/kerberosec.TaskService/executeQuickWin" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Deletes all task history */
  deleteAllTaskHistory: {
    path: "/kerberosec.TaskService/deleteAllTaskHistory" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
...
export interface TaskServiceServer extends UntypedServiceImplementation {
   ...
   * the agent receives the partial output and a log file path for the rest.
   */
  proceedWhileRunningCommand: handleUnaryCall<EmptyRequest, Empty>;
  /** Clears the current task */
