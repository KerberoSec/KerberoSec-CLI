 ...
 *
 * CLI usage:
 *   kerberosec plugin install https://github.com/kerberosec/kerberosec/blob/main/sdk/examples/plugins/telemetry.ts --cwd .
 *   kerberosec -i "Roll a die a few times and tell me your best roll."
 */
