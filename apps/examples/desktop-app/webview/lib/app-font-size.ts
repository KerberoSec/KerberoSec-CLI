export const APP_FONT_SIZE_STORAGE_KEY = "kerberosec.code.font-size.v1";
export const APP_FONT_SIZE_CHANGE_EVENT = "kerberosec-app-font-size-change";
...
export const APP_FONT_SIZE_BOOTSTRAP_SCRIPT = `(() => {
	...
	root.dataset.kerberosecFontSize = String(fontSize);
})();`;
...
export function applyAppFontSize(fontSize: AppFontSize): AppFontSize {
	...
	document.documentElement.dataset.kerberosecFontSize = String(fontSize);
