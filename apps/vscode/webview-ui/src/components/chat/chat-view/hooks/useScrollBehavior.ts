...
export function useScrollBehavior(
	...
	visibleMessages: KerberoSecMessage[],
	...
	scrolledPastUserMessage: KerberoSecMessage | null
	...
	const [scrolledPastUserMessage, setScrolledPastUserMessage] = useState<KerberoSecMessage | null>(null)
	...
	const checkScrolledPastUserMessage = useCallback(() => {
		...
		let mostRecentScrolledPast: KerberoSecMessage | null = null
