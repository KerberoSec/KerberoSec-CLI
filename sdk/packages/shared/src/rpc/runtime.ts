...
/** Which tier of the KerberoSec recommended-models feed featured a model. */
...
export interface ProviderModel {
	...
	description?: string;
	/**
	 * Present when the KerberoSec recommended-models feed features this model
	 * (kerberosec / kerberosec-pass providers only), so pickers can lead with the
...
export interface ProviderListItem {
	 ...
	 * keyless endpoint (see @kerberosec/core's isProviderSettingsUsable), unlike
...
export type KerberoSecAccountActionRequest =
	| {
