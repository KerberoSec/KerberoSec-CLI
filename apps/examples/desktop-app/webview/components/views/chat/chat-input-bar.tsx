...
} from "@kerberosec/shared/browser";
import { AgentPromptQueue, SearchCombobox } from "@kerberosec/ui";
...
const FALLBACK_PROVIDER_MODELS: Record<string, string[]> = {
	kerberosec: [KERBEROSEC_DEFAULT_MODEL_ID],
...
const ModelSelector = memo(function ModelSelector({
	...
	// SDK stamps onto kerberosec/kerberosec-pass models (ProviderModel.featured).
	...
	// The picker can intentionally hide catalog models (the KerberoSecPass offer
	...
	const handleProviderSelect = useCallback(
		(value: string) => {
			...
			// outside the KerberoSecPass offer) must not become the selection.
	...
	return (
		<div className="relative min-w-0 shrink-0 text-sm">
			...
			<div className="flex min-w-0 items-center gap-0.5 max-[560px]:hidden">
				{/* Wide enough for the longest built-in provider names ("KerberoSec
