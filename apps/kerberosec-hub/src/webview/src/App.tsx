				...
				<div className="mt-auto pt-6 max-[720px]:mt-2 max-[720px]:pt-0">
					<div className="flex min-w-0 items-center gap-2 px-2 text-xs text-muted-foreground">
						...
						<a
							...
							href="https://github.com/kerberosec/kerberosec/issues/new"
	...
	return (
		<PageFrame>
			...
			>
				<AlertDialogContent>
					<AlertDialogHeader>
						<AlertDialogTitle>Restart KerberoSec Hub</AlertDialogTitle>
						<AlertDialogDescription>
