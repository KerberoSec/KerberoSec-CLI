...
`dist/extension.js` as CommonJS under Node, and the standalone `kerberosec-core` is a
...
| `NODE_PATH=... node kerberosec-core.js` | The standalone core is launched by Node, not bun. |
