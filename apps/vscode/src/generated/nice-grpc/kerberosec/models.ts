...
export const ModelOverrides: MessageFns<ModelOverrides> = {
  ...
  create(base?: DeepPartial<ModelOverrides>): ModelOverrides {
    return ModelOverrides.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ModelOverrides>): ModelOverrides {
    const message = createBaseModelOverrides();
    message.name = object.name ?? undefined;
    message.maxTokens = object.maxTokens ?? undefined;
    message.contextWindow = object.contextWindow ?? undefined;
...
export const KerberoSecRecommendedModel: MessageFns<KerberoSecRecommendedModel> = {
  ...
  create(base?: DeepPartial<KerberoSecRecommendedModel>): KerberoSecRecommendedModel {
    return KerberoSecRecommendedModel.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<KerberoSecRecommendedModel>): KerberoSecRecommendedModel {
    const message = createBaseKerberoSecRecommendedModel();
    message.id = object.id ?? "";
    message.name = object.name ?? "";
...
export const KerberoSecRecommendedModelsResponse: MessageFns<KerberoSecRecommendedModelsResponse> = {
  ...
  create(base?: DeepPartial<KerberoSecRecommendedModelsResponse>): KerberoSecRecommendedModelsResponse {
    return KerberoSecRecommendedModelsResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<KerberoSecRecommendedModelsResponse>): KerberoSecRecommendedModelsResponse {
    const message = createBaseKerberoSecRecommendedModelsResponse();
...
export interface ModelsServiceImplementation<CallContextExt = {}> {
  ...
  refreshKerberoSecRecommendedModelsRpc(
    request: EmptyRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<KerberoSecRecommendedModelsResponse>>;
  /** Refreshes and returns Hugging Face models */
  refreshHuggingFaceModels(
    request: EmptyRequest,
    context: CallContext & CallContextExt,
