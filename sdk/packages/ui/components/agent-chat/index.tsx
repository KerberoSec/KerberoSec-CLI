	...
	({ children, className, ...props }, ref) => {
		...
		return (
			<ConversationContext.Provider value={value}>
				<div
					className={classNames("kerberosec-chat-conversation", className)}
					ref={ref}
					{...props}
				>
					{children}
		...
		return (
			<div
				...
				className={classNames(
					"kerberosec-chat-conversation-viewport",
					className,
				)}
				ref={ref}
				role="log"
...
>(({ className, ...props }, forwardedRef) => {
	...
	return (
		<div
			className={classNames("kerberosec-chat-conversation-content", className)}
			ref={ref}
			{...props}
		/>
	);
...
export const ConversationEmptyState = ({
	...
	<div
		className={classNames("kerberosec-chat-empty-state", className)}
		{...props}
	>
		{children ?? (
			<>
				{icon ? (
					<div className="kerberosec-chat-empty-state-icon">{icon}</div>
				) : null}
				<div>
					<h3>{title}</h3>
...
export const ConversationScrollButton = ({
	...
	return (
		<button
			{...props}
			aria-label={ariaLabel}
			className={classNames("kerberosec-chat-scroll-button", className)}
			onClick={(event) => {
				onClick?.(event);
...
export const Message = ({ className, from, ...props }: MessageProps) => (
	<div
		{...props}
		className={classNames("kerberosec-chat-message", className)}
		data-role={from}
	/>
);
...
export const MessageContent = ({
	...
	<div
		className={classNames("kerberosec-chat-message-content", className)}
		{...props}
	/>
);
...
export const MessageActions = ({
	...
	<div
		{...props}
		className={classNames("kerberosec-chat-message-actions", className)}
		data-side={side}
...
export const MessageAction = ({
	...
	<IconButton
		...
		className={classNames("kerberosec-chat-message-action", className)}
		variant="ghost"
		tone="neutral"
		size="xs"
	/>
...
export const Reasoning = ({
	...
	return (
		<ReasoningContext.Provider value={value}>
			<div
				{...props}
				className={classNames("kerberosec-chat-reasoning", className)}
...
export const ReasoningTrigger = ({
	...
	return (
		<button
			...
			className={classNames("kerberosec-chat-reasoning-trigger", className)}
			onClick={(event) => {
				onClick?.(event);
		...
		>
			{children ?? (
				<>
					...
					<ChevronDownIcon className="kerberosec-chat-disclosure-icon" />
				</>
			)}
		</button>
	);
...
export const ReasoningContent = ({
	...
	return (
		<DisclosureContent
			{...props}
			contentClassName="kerberosec-chat-reasoning-content"
			isOpen={isOpen}
			lazyContent
			panelId={panelId}
	...
	return (
		...
		>
			<ReasoningTrigger aria-label={resolvedLabel}>
				<BrainIcon className="kerberosec-chat-thinking-icon" />
				<span
					className={
						isStreaming ? "kerberosec-chat-streaming-title" : undefined
					}
				>
					{resolvedLabel}
				</span>
			...
			<ReasoningContent
				className="kerberosec-chat-thinking-content"
				presentation="rail"
			>
...
export const ToolActivity = ({
	...
	return (
		<ToolActivityContext.Provider value={value}>
			<div
				{...props}
				className={classNames("kerberosec-chat-tool", className)}
...
export const ToolActivityTrigger = ({
	...
	const content = children ?? (
		<>
			{inFlight ? (
				<output aria-label={status} className="kerberosec-chat-tool-progress" />
			) : icon ? (
				<span className="kerberosec-chat-tool-icon">{icon}</span>
			) : null}
			<span className="kerberosec-chat-tool-label">{label}</span>
			{additions !== undefined || deletions !== undefined ? (
				<span className="kerberosec-chat-tool-diff">
					{additions !== undefined ? (
...
export const ToolActivityContent = ({
	...
	return (
		<DisclosureContent
			{...props}
			contentClassName="kerberosec-chat-tool-content"
			isOpen={isOpen}
			lazyContent
			panelId={panelId}
			presentation={presentation}
...
export const WorkActivity = ({
	...
	return (
		<WorkActivityContext.Provider value={value}>
			<div
				{...props}
				className={classNames("kerberosec-chat-work", className)}
			/>
...
export const WorkActivityTrigger = ({
	...
	return (
		<button
			...
			aria-controls={panelId}
			aria-expanded={isOpen}
			className={classNames("kerberosec-chat-work-trigger", className)}
			onClick={(event) => {
				onClick?.(event);
				if (!event.defaultPrevented) setIsOpen(!isOpen);
			}}
		...
		>
			{children ?? (
				<>
					<span className="kerberosec-chat-tool-label">
...
export const WorkActivityContent = ({
	...
	return (
		<DisclosureContent
			{...props}
			contentClassName="kerberosec-chat-work-content"
			isOpen={isOpen}
			lazyContent
			panelId={panelId}
			presentation={presentation}
...
export const ToolActivityDetails = ({
	...
	<div
		className={classNames("kerberosec-chat-tool-details", className)}
		{...props}
	/>
);
...
export const ToolActivityCode = ({
	...
	<pre
		className={classNames("kerberosec-chat-tool-code", className)}
		{...props}
	/>
);
