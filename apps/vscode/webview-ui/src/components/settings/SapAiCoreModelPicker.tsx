import { SapAiCoreModelDeployment } from "@shared/proto/index.kerberosec"
...
const SapAiCoreModelPicker: React.FC<SapAiCoreModelPickerProps> = ({
	...
	const categorizedModels = useMemo(() => {
		...
		// Models that are both deployed AND supported in KerberoSec
		...
		// Models that are supported in KerberoSec but NOT deployed
