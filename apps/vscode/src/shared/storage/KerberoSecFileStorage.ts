...
import { KerberoSecSyncStorage } from "./KerberoSecStorage"

export interface KerberoSecFileStorageOptions {
	/**
 ...
 */
export class KerberoSecFileStorage<T = any> extends KerberoSecSyncStorage<T> {
	protected name: string
	private data: Record<string, T>
	private readonly fsPath: string
	private readonly fileMode?: number

	constructor(filePath: string, name = "KerberoSecFileStorage", options?: KerberoSecFileStorageOptions) {
		super()
