...
Send a test message in KerberoSec to verify your credentials work correctly with the configured endpoint.
...
Confirm you're signed into the correct KerberoSec organization. Verify your administrator has saved the configuration and that you have the latest version of the KerberoSec extension.
