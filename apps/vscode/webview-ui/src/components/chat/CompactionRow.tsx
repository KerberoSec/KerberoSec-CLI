...
function parseCompactionInfo(text: string | undefined): KerberoSecCompactionInfo | undefined {
	if (!text) {
		return undefined
	}
	try {
		...
		if (parsed && typeof parsed === "object" && typeof parsed.status === "string") {
			return parsed as KerberoSecCompactionInfo
		}
	} catch {
...
function formatCompactionLabel(info: KerberoSecCompactionInfo): string {
 ...
 */
export const CompactionRow = ({ message }: { message: KerberoSecMessage }) => {
