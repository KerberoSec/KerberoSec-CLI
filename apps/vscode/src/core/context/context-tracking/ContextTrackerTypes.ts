...
export interface FileMetadataEntry {
	...
	record_source: "read_tool" | "user_edited" | "kerberosec_edited" | "file_mentioned"
	kerberosec_read_date: number | null
	kerberosec_edit_date: number | null
