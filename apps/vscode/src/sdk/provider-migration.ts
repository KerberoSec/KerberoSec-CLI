 ...
 *
 * @param dataDir Override for the KerberoSec data directory. Defaults to
 *   resolveDataDir() which checks KERBEROSEC_DATA_DIR, KERBEROSEC_DIR, then ~/.kerberosec/data.
...
export function migrateProviders(dataDir?: string): ProviderMigrationResult {
	...
	try {
		...
		// the correct dataDir, not the default ~/.kerberosec/data.
