...
//   - "dark" / "light" force the corresponding KerberoSec palette and paint a
//     matching background, for terminals whose reported colors are missing or
//     wrong (see kerberosec/kerberosec#12872).
...
export const THEMES: readonly ThemeDefinition[] = [
	...
	{
		id: "dark",
		label: "KerberoSec Dark",
		description: "KerberoSec's accents on deep charcoal",
		variant: "dark",
		background: "#14161b",
		foreground: "#e8eaed",
	},
