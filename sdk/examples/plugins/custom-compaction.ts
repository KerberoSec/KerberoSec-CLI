 ...
 *
 * CLI usage:
 *   kerberosec plugin install https://github.com/kerberosec/kerberosec/blob/main/sdk/examples/plugins/custom-compaction.ts --cwd .
 *   kerberosec -i "Search the codebase for dispatcher usage, then summarize it"
 */

import type { AgentPlugin, Message, ToolResultContent } from "@kerberosec/core";
import { estimateTokens as estimateTokensFromChars } from "@kerberosec/shared";
