...
import { Empty, EmptyRequest, String, StringRequest } from "../kerberosec/common";
...
export interface GetHostVersionResponse {
  ...
  kerberosecType?:
    | string
    | undefined;
  /** The version of the kerberosec host environment, e.g. 33.2.10 for extension, or 1.0.6 for JetBrains. */
  kerberosecVersion?:
    | string
    | undefined;
  /**
...
function createBaseGetHostVersionResponse(): GetHostVersionResponse {
  return {
    platform: undefined,
    version: undefined,
    kerberosecType: undefined,
    kerberosecVersion: undefined,
...
export const GetHostVersionResponse: MessageFns<GetHostVersionResponse> = {
  encode(message: GetHostVersionResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.kerberosecType !== undefined) {
      writer.uint32(26).string(message.kerberosecType);
    }
    if (message.kerberosecVersion !== undefined) {
      writer.uint32(34).string(message.kerberosecVersion);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.kerberosecType = reader.string();
          continue;
        }
        case 4: {
          if (tag !== 34) {
          ...
          message.kerberosecVersion = reader.string();
          continue;
        }
        case 5: {
          if (tag !== 42) {
  ...
  fromJSON(object: any): GetHostVersionResponse {
    return {
      ...
      kerberosecType: isSet(object.kerberosecType)
        ? globalThis.String(object.kerberosecType)
        : isSet(object.kerberosec_type)
        ? globalThis.String(object.kerberosec_type)
        : undefined,
      kerberosecVersion: isSet(object.kerberosecVersion)
        ? globalThis.String(object.kerberosecVersion)
        : isSet(object.kerberosec_version)
        ? globalThis.String(object.kerberosec_version)
        : undefined,
  ...
  toJSON(message: GetHostVersionResponse): unknown {
    ...
    if (message.kerberosecType !== undefined) {
      obj.kerberosecType = message.kerberosecType;
    }
    if (message.kerberosecVersion !== undefined) {
      obj.kerberosecVersion = message.kerberosecVersion;
    }
    if (message.remoteName !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<GetHostVersionResponse>, I>>(object: I): GetHostVersionResponse {
    ...
    message.kerberosecType = object.kerberosecType ?? undefined;
    message.kerberosecVersion = object.kerberosecVersion ?? undefined;
