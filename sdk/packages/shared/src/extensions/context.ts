...
/**
 * The IDE or client surface the user is running KerberoSec from.
 */
export type ClientName =
	| "kerberosec-vscode"
	| "kerberosec-jetbrains"
	| "kerberosec-cli"
	| "kerberosec-sdk"
	| "kerberosec-kanban"
	| "kerberosec-acp"
...
export interface ClientContext {
	/** Client type emitted to KerberoSec request headers, e.g. "VSCode Extension", "kerberosec-cli", "kerberosec-sdk" */
	name: ClientName;
	/** KerberoSec client/extension semver string, e.g. "3.12.0" */
	version?: string;
 ...
 * required by buildKerberoSecSystemPrompt, so callers can spread a WorkspaceInfo
...
export interface WorkspaceContext extends WorkspaceInfo {
	...
	/**
	 * Pre-serialized workspace metadata block that replaces {{KERBEROSEC_METADATA}}
...
export interface ExtensionContext {
	 ...
	 * started through a KerberoSecCore instance with automation enabled.
	 */
