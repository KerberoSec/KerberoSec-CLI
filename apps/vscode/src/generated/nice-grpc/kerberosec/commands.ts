...
//   protoc               v3.19.1
// source: kerberosec/commands.proto
...
export const CommandsServiceDefinition = {
  ...
  fullName: "kerberosec.CommandsService",
  methods: {
    addToKerberoSec: {
      name: "addToKerberoSec",
...
export interface CommandsServiceImplementation<CallContextExt = {}> {
  addToKerberoSec(request: CommandContext, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
  fixWithKerberoSec(request: CommandContext, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
  explainWithKerberoSec(request: CommandContext, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
  improveWithKerberoSec(request: CommandContext, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
}

export interface CommandsServiceClient<CallOptionsExt = {}> {
  addToKerberoSec(request: DeepPartial<CommandContext>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
  fixWithKerberoSec(request: DeepPartial<CommandContext>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
  explainWithKerberoSec(request: DeepPartial<CommandContext>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
  improveWithKerberoSec(request: DeepPartial<CommandContext>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
}
