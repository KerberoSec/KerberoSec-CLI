...
export const addSelectedCodeToKerberoSecWebview = async (_page: Page) => {
	...
	const addToKerberoSec = _page.getByText(/Add to KerberoSec/i)
	await addToKerberoSec.waitFor({ state: "visible" })
