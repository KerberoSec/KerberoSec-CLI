...
function resolveKerberoSecBin(): string {
	...
	throw new Error(
		"Unable to resolve kerberosec binary. Run bun -F @kerberosec/cli build",
	);
}

export const KERBEROSEC_BIN = resolveKerberoSecBin();
