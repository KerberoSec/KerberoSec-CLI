 ...
 * - `generatedProviderId` is KerberoSec's canonical ID for the provider spec and
 ...
 *   KerberoSec's public provider IDs.
 ...
 * supported AI SDK package. IDs use KerberoSec's generated provider identifiers
