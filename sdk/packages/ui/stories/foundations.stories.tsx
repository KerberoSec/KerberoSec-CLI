...
const meta: Meta = {
	...
	parameters: {
		docs: {
			description: {
				component:
					"KerberoSec-owned color palettes feed readable visual roles and the shadcn semantic compatibility contract. Use the toolbar to compare light and dark modes.",
			},
		},
	},
};
...
export const Overview = () => (
	<main className="mx-auto grid max-w-6xl gap-10 p-8">
		<header className="space-y-3">
			<p className="text-sm font-medium text-primary">@kerberosec/ui</p>
			<h1 className="text-4xl font-semibold tracking-tight">
				KerberoSec visual foundations
			</h1>
			<p className="max-w-3xl text-base text-muted-foreground">
				Adjust KerberoSec-owned palettes and visual roles; shadcn semantic
				tokens remain the stable component compatibility layer.
			</p>
		</header>

		<section className="space-y-4">
			<div>
				<h2 className="text-xl font-semibold">KerberoSec-owned palettes</h2>
		...
		<section className="grid gap-6 md:grid-cols-2">
			...
			<div className="space-y-4 rounded-xl border bg-card p-6">
				...
				<input
					...
					placeholder="Ask KerberoSec something..."
				/>
			</div>
		</section>
	</main>
