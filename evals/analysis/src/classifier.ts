/**
 * Failure classification system for KerberoSec evaluations
 *
...
export class FailureClassifier {
	...
	constructor(patternsPath?: string) {
		const defaultPath = path.join(__dirname, "../patterns/kerberosec-failures.yaml")
	 ...
	 * @param logs Full log text (e.g., kerberosec.txt content)
