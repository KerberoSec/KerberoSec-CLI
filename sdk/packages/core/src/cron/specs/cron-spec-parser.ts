...
/**
 * Markdown frontmatter parser for `.kerberosec/cron/*.md` automation specs.
 *
 * Lives in @kerberosec/core because it depends on `yaml`. The spec types
 * themselves live in @kerberosec/shared so other packages can consume them
