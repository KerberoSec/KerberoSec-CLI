...
# 
# Executes when the user submits a prompt to KerberoSec.
# 
# Input: { taskId, userPromptSubmit: { prompt: string, attachments: string[] }, kerberosecVersion, timestamp, ... }
# Output: { cancel: boolean, contextModification?: string, errorMessage?: string }
# 
# Use cases:
...
# Notification Hook
#
# Executes when KerberoSec reaches a user-attention boundary or emits lifecycle notifications.
#
# Input: {
#   taskId,
#   notification: {
