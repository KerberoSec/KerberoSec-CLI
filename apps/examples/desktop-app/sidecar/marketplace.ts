...
async function installPlugin(
	...
	// Install in-process instead of shelling out to a `kerberosec` binary: the
	...
	// as 'Executable not found in $PATH: "kerberosec"' in the marketplace UI.
	//
...
export async function installMarketplaceEntry(
	...
	if (entry.type === "mcp") {
		...
		// there is no reason to depend on a `kerberosec` binary being on PATH.
