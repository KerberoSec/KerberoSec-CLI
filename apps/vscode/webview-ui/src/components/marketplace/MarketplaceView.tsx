...
const PRIMITIVES: PrimitiveConfig[] = [
	{
		...
		description: (
			<>
				Reusable instruction sets that KerberoSec loads on demand for specific tasks, without staying in context for unrelated
	...
	},
	{
		...
		description: (
			<>
				Connect KerberoSec to external APIs, local tools, and hosted services through{" "}
...
// (see https://github.com/kerberosec/kerberosec/pull/12522). MCP servers and skills are unaffected.
