...
import { nowIso } from "@kerberosec/shared/db";
import type { ResolveCronSpecsDirOptions } from "@kerberosec/shared/storage";
...
export interface CronRunnerOptions {
	...
	/** Cron spec source/report location. Defaults to global `~/.kerberosec/cron`. */
...
export class CronRunner {
	...
	private async buildSystemPrompt(
		...
		const base = buildKerberoSecSystemPrompt({
			ide: "KerberoSec Cron",
			workspaceRoot,
