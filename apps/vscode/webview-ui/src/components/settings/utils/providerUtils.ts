...
// gRPC and ultimately reads from `@kerberosec/llms`. Do not add a static
...
export function getModeSpecificFields(apiConfiguration: ApiConfiguration | undefined, mode: Mode) {
	if (!apiConfiguration) {
		return {
			...
			kerberosecModelId: undefined,
			kerberosecPassModelId: undefined,
	...
	const kerberosecModelId = mode === "plan" ? apiConfiguration.planModeKerberoSecModelId : apiConfiguration.actModeKerberoSecModelId
	const kerberosecModelInfo = mode === "plan" ? apiConfiguration.planModeKerberoSecModelInfo : apiConfiguration.actModeKerberoSecModelInfo
	const kerberosecPassModelId =
		mode === "plan" ? apiConfiguration.planModeKerberoSecPassModelId : apiConfiguration.actModeKerberoSecPassModelId
	const kerberosecPassModelInfo =
		mode === "plan" ? apiConfiguration.planModeKerberoSecPassModelInfo : apiConfiguration.actModeKerberoSecPassModelInfo
...
export async function syncModeConfigurations(
	...
	switch (apiProvider) {
		...
		case "kerberosec":
			updates.planModeKerberoSecModelId = sourceFields.kerberosecModelId
			updates.actModeKerberoSecModelId = sourceFields.kerberosecModelId
			updates.planModeKerberoSecModelInfo = sourceFields.kerberosecModelInfo
			updates.actModeKerberoSecModelInfo = sourceFields.kerberosecModelInfo
			break

		case "kerberosec-pass":
			updates.planModeKerberoSecPassModelId = sourceFields.kerberosecPassModelId
			updates.actModeKerberoSecPassModelId = sourceFields.kerberosecPassModelId
			updates.planModeKerberoSecPassModelInfo = sourceFields.kerberosecPassModelInfo
			updates.actModeKerberoSecPassModelInfo = sourceFields.kerberosecPassModelInfo
			break
