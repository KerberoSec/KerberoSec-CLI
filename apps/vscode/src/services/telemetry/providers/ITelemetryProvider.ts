...
export interface ITelemetryProvider {
	 ...
	 */
	identifyUser(userInfo: KerberoSecAccountUserInfo, properties?: TelemetryProperties): void
	 ...
	 * @param name Metric name (e.g., "kerberosec.tokens.input")
	 ...
	 * Providers that don't support metrics may implement this as a no-op.
	 * @param name Metric name (e.g., "kerberosec.api.duration_seconds")
	 ...
	 * Providers that don't support metrics may implement this as a no-op.
	 * @param name Metric name (e.g., "kerberosec.workspace.active_roots")
