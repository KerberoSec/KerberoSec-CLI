...
export function AgentAurora() {
	return (
		<div aria-hidden="true" className="kerberosec-ui-agent-aurora">
			<div className="kerberosec-ui-agent-aurora__horizon kerberosec-ui-agent-aurora__soft-band" />
			<div className="kerberosec-ui-agent-aurora__current kerberosec-ui-agent-aurora__current--left kerberosec-ui-agent-aurora__soft-band" />
			<div className="kerberosec-ui-agent-aurora__current kerberosec-ui-agent-aurora__current--right kerberosec-ui-agent-aurora__soft-band" />
			{BLOBS.map((blob) => (
				<div
					className={`kerberosec-ui-agent-aurora__blob kerberosec-ui-agent-aurora__blob--${blob.position}`}
					key={blob.id}
					style={{
			...
			{STARS.map((star) => (
				<span
					className="kerberosec-ui-agent-aurora__star"
