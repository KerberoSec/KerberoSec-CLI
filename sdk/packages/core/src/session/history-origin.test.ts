...
describe("session history origin", () => {
	...
	it.each([
		...
		{ name: "KerberoSec for JetBrains", source: "jetbrains" },
		{ name: "KerberoSec", source: "jetbrains", platform: "WebStorm" },
		{ name: "kerberosec-cli", source: "cli" },
		{ name: "kerberosec-acp", source: "cli" },
		{ name: "kerberosec-sdk", source: "core" },
		{ name: "kerberosec-kanban", source: "kanban" },
		{ name: "KerberoSec Desktop", source: "desktop" },
