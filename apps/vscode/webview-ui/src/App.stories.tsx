...
import type { KerberoSecMessage, KerberoSecSayTool } from "@shared/ExtensionMessage"
...
const meta: Meta<typeof MockApp> = {
	...
	parameters: {
		...
		docs: {
			description: {
				component: `
The ChatView component is the main interface for interacting with KerberoSec. It provides a comprehensive chat experience with AI assistance, task management, and various tools.
...
const createMessage = (
	minutesAgo: number,
	type: KerberoSecMessage["type"],
	say: KerberoSecMessage["say"],
	text: string,
	overrides: Partial<KerberoSecMessage> = {},
): KerberoSecMessage => ({
...
const mockActiveMessages: KerberoSecMessage[] = [
...
const mockStreamingMessages: KerberoSecMessage[] = [
	...mockActiveMessages,
	createMessage(
		0.17,
		"say",
...
const createMockState = (overrides: any = {}) => ({
	...
	showWelcome: false,
	kerberosecMessages: mockActiveMessages,
...
export const Welcome: Story = {
	decorators: [createStoryDecorator({ welcomeViewCompleted: false, showWelcome: true, kerberosecMessages: [] })],
	parameters: {
		docs: {
			description: {
...
export const Onboarding: Story = {
	...
	play: async ({ canvasElement }) => {
		...
		const title = canvas.getByText("How will you use KerberoSec?")
		...
		await expect(canvas.getByText("How will you use KerberoSec?")).toBeInTheDocument()
...
export const EmptyState: Story = {
	decorators: [createStoryDecorator({ kerberosecMessages: [], taskHistory: [], isNewUser: true, showAnnouncement: true })],
	parameters: {
		docs: {
			description: {
...
export const ReturnUser: Story = {
	decorators: [
		createStoryDecorator({ kerberosecMessages: [], taskHistory: mockTaskHistory, isNewUser: true, showAnnouncement: false }),
	],
	parameters: {
		docs: {
			description: {
...
export const ActiveConversation: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "An active conversation showing a typical interaction with KerberoSec, including task creation, tool usage, and AI responses.",
			},
		},
	},
}
...
export const StreamingResponse: Story = {
	decorators: [createStoryDecorator({ kerberosecMessages: mockStreamingMessages })],
	parameters: {
		docs: {
			description: {
...
const createLongMessages = (): KerberoSecMessage[] => [
...
export const LongConversation: Story = {
	decorators: [createStoryDecorator({ kerberosecMessages: createLongMessages() })],
	parameters: {
		docs: {
			description: {
...
export const ErrorState: Story = {
	decorators: [createStoryDecorator({ kerberosecMessages: createErrorMessages() })],
	parameters: {
		docs: {
			description: {
				story: "Shows how KerberoSec handles and displays error messages, helping users understand and resolve issues.",
			},
		},
	},
}
...
export const AutoApprovalEnabled: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Shows the interface with auto-approval enabled, allowing KerberoSec to execute certain actions automatically without user confirmation.",
			},
		},
	},
}
...
export const PlanMode: Story = {
	decorators: [
		createStoryDecorator({
			kerberosecMessages: createPlanModeMessages(),
	...
	parameters: {
		docs: {
			description: {
				story: "Shows KerberoSec in Plan mode, where it focuses on creating detailed plans and discussing approaches before implementation.",
			},
		},
	},
}
...
export const BrowserAutomation: Story = {
	decorators: [createStoryDecorator({ kerberosecMessages: createBrowserMessages() })],
	parameters: {
		docs: {
			description: {
				story: "Shows KerberoSec performing browser automation tasks, including launching browsers, clicking elements, and testing web applications.",
			},
		},
	},
}
...
export const ToolApproval: Story = {
	decorators: [createStoryDecorator({ kerberosecMessages: createToolApprovalMessages() })],
	parameters: {
		docs: {
			description: {
...
export const Followup = quickStory(
	...
	"Shows followup question state where KerberoSec asks for next steps.",
)
...
export const PlanModeResponse = quickStory(
	...
	"plan_mode_respond",
	"Here's my comprehensive plan for refactoring your React application with TypeScript migration and performance optimization phases.\n\n\n\n\nPhase 1: TypeScript Migration\n1. Set up TypeScript in the project\n2. Rename .js files to .tsx/.ts\n3. Add type definitions for components and props\n4. Fix type errors and ensure type safety\n\nPhase 2: Performance Optimization\n1. Analyze current performance bottlenecks\n2. Implement code-splitting and lazy loading\n3. Optimize rendering with React.memo and useCallback\n4. Minimize bundle size with tree-shaking and minification\n5. Test performance improvements using profiling tools",
	"Shows plan mode response where KerberoSec presents a detailed plan for user approval.",
)
...
export const ReportBug = quickStory(
	...
	"report_bug",
	JSON.stringify({
		steps_to_reproduce: "1. Open KerberoSec\n2. Start a new task\n3. Observe the error",
		what_happened: "KerberoSec crashes unexpectedly",
	}),
...
export const DiffEditNewFormat: Story = {
	decorators: [createStoryDecorator({ backgroundEditEnabled: true, kerberosecMessages: createNewFormatMultiFileMessages() })],
	parameters: {
		docs: {
			description: {
...
export const DiffEditNewFormatStreaming: Story = {
	decorators: [
		(Story) => {
			const [messages, setMessages] = useState<KerberoSecMessage[]>([
			...
			const mockState = useMemo(() => createMockState({ backgroundEditEnabled: true, kerberosecMessages: messages }), [messages])
...
*** End Patch`
				...
				const timer1 = setTimeout(() => {
					setMessages((prev: KerberoSecMessage[]) => [
						...prev,
...
export const DiffEditReplaceDiffFormat: Story = {
	decorators: [createStoryDecorator({ backgroundEditEnabled: true, kerberosecMessages: createReplaceDiffFormatPatchMessages() })],
	parameters: {
		docs: {
			description: {
...
export const DiffEditMixedFormats: Story = {
	decorators: [createStoryDecorator({ kerberosecMessages: createMixedFormatMessages() })],
	parameters: {
		docs: {
			description: {
