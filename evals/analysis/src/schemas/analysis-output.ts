/**
 * Type definitions for KerberoSec Analysis Framework output
...
export interface AnalysisMetadata {
	...
	agent: string // Agent name (e.g., "kerberosec-cli")
...
export type FailureCategory =
	| "provider_bug" // KerberoSec integration bugs (Gemini #7974, Claude #7998)
