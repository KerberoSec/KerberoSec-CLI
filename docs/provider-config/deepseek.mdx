...
3.  **Create a Key:** Click "Create new API key". Give your key a descriptive name (e.g., "KerberoSec").
...
1.  **Open KerberoSec Settings:** Click the ⚙️ icon in the KerberoSec panel.
