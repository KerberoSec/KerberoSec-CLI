...
const ProviderKeyMap: Partial<Record<ApiProvider, string>> = {
	...
	kerberosec: "KerberoSecModelId",
	"kerberosec-pass": "KerberoSecPassModelId",
 ...
 * provider. Dynamic-list providers (openrouter, kerberosec, requesty, etc.)
...
const NON_SDK_PROVIDER_DEFAULTS: Partial<Record<ApiProvider, string>> = {
	...
	kerberosec: openRouterDefaultModelId,
	"kerberosec-pass": kerberosecPassDefaultModelId,
