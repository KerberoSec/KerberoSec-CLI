...
if [ "$#" -ne 3 ]; then
    ...
    echo ""
    echo "Example:"
    echo "  $0 kerberosec-3.55.0.vsix kerberosec-3.55.0-enterprise.vsix endpoints.json"
    exit 1
fi
...
echo "When installed, KerberoSec will automatically use the bundled configuration."
