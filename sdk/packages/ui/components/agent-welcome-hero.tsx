...
/** KerberoSec bot illustration and grid backdrop used on agent welcome surfaces. */
export function AgentWelcomeHero({
	...
	return (
		<div
			aria-hidden="true"
			className="kerberosec-ui-agent-welcome-hero"
			data-welcome-hero
		...
		>
			{showsGrid ? (
				<div
					className="kerberosec-ui-agent-welcome-hero__grid"
			...
			{showsBot ? (
				<>
					<span
						className="kerberosec-ui-agent-welcome-hero__inner"
						data-welcome-hero-layer="inner"
					/>
					<span
						className="kerberosec-ui-agent-welcome-hero__bot-fill"
						data-welcome-hero-layer="bot-fill"
					/>
					<span
						className="kerberosec-ui-agent-welcome-hero__bot-outline"
						data-welcome-hero-layer="bot-outline"
					/>
					<span
						className="kerberosec-ui-agent-welcome-hero__eye kerberosec-ui-agent-welcome-hero__eye--left"
						data-welcome-hero-eye="left"
					/>
					<span
						className="kerberosec-ui-agent-welcome-hero__eye kerberosec-ui-agent-welcome-hero__eye--right"
