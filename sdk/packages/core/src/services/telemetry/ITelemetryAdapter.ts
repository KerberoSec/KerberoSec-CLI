/**
 * Telemetry adapter interface for the @kerberosec/core SDK.
 *
...
import type { TelemetryProperties } from "@kerberosec/shared";
 ...
 * provided {@link OpenTelemetryAdapter}) to receive KerberoSec telemetry events.
 *
