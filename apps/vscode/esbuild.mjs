...
const buildEnvVars = {
	...
	"process.env.KERBEROSEC_ROLLOUT_VARIANT": JSON.stringify(process.env.KERBEROSEC_ROLLOUT_VARIANT || ""),
}
...
if (process.env.KERBEROSEC_ENVIRONMENT) {
	buildEnvVars["process.env.KERBEROSEC_ENVIRONMENT"] = JSON.stringify(process.env.KERBEROSEC_ENVIRONMENT)
}
...
const standaloneConfig = {
	...baseConfig,
	entryPoints: ["src/standalone/kerberosec-core.ts"],
	outfile: `${destDir}/kerberosec-core.js`,
