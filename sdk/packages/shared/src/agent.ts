/**
 * AgentRuntime contract types (ported from kerberosece `@kerberosec/shared`).
 *
...
export interface AgentRuntimeConfig {
	 ...
	 */
	distinctId?: string;
	/** Calling client surface, for example `kerberosec-vscode` or `kerberosec-sdk`. */
	clientName?: string;
	/** Calling client version, such as the VS Code extension version. */
	clientVersion?: string;
	/** Version of the KerberoSec Core SDK executing the runtime. */
	kerberosecCoreVersion?: string;
	/**
