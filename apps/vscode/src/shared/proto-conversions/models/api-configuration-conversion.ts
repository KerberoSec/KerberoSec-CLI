import {
	...
	ThinkingConfig,
} from "@shared/proto/kerberosec/models"
import {
	ApiConfiguration,
	ApiProvider,
...
export function convertApiConfigurationToProto(config: ApiConfiguration): ProtoApiConfiguration {
	return {
		...
		kerberosecAccountId: config.kerberosecAccountId,
		ulid: config.ulid,
		...
		kerberosecApiKey: config.kerberosecApiKey,
		...
		planModeKerberoSecModelId: config.planModeKerberoSecModelId,
		planModeKerberoSecModelInfo: convertModelInfoToProtoOpenRouter(config.planModeKerberoSecModelInfo),
		planModeKerberoSecPassModelId: config.planModeKerberoSecPassModelId,
		planModeKerberoSecPassModelInfo: convertModelInfoToProtoOpenRouter(config.planModeKerberoSecPassModelInfo),
		...
		actModeKerberoSecModelId: config.actModeKerberoSecModelId,
		actModeKerberoSecModelInfo: convertModelInfoToProtoOpenRouter(config.actModeKerberoSecModelInfo),
		actModeKerberoSecPassModelId: config.actModeKerberoSecPassModelId,
		actModeKerberoSecPassModelInfo: convertModelInfoToProtoOpenRouter(config.actModeKerberoSecPassModelInfo),
...
export function convertProtoToApiConfiguration(protoConfig: ProtoApiConfiguration): ApiConfiguration {
	return {
		...
		kerberosecAccountId: protoConfig.kerberosecAccountId,
		...
		kerberosecApiKey: protoConfig.kerberosecApiKey,
		...
		planModeKerberoSecModelId: protoConfig.planModeKerberoSecModelId,
		planModeKerberoSecModelInfo: convertProtoToModelInfo(protoConfig.planModeKerberoSecModelInfo),
		planModeKerberoSecPassModelId: protoConfig.planModeKerberoSecPassModelId,
		planModeKerberoSecPassModelInfo: convertProtoToModelInfo(protoConfig.planModeKerberoSecPassModelInfo),
		...
		actModeKerberoSecModelId: protoConfig.actModeKerberoSecModelId,
		actModeKerberoSecModelInfo: convertProtoToModelInfo(protoConfig.actModeKerberoSecModelInfo),
		actModeKerberoSecPassModelId: protoConfig.actModeKerberoSecPassModelId,
		actModeKerberoSecPassModelInfo: convertProtoToModelInfo(protoConfig.actModeKerberoSecPassModelInfo),
