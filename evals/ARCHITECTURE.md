...
The evals system provides multi-layered testing for KerberoSec's AI capabilities.
...
│                     /    (kerberosec provider)    \   - 3 models via Vercel      │
...
│   ├── run-kerberosec-bench.ts   # Harbor runner
│   └── README.md
│
└── kerberosec-bench/             # Git submodule with real coding tasks
...
│  │  │  (Sequential - KerberoSec instance handles one at a time)  │  │
│  │  │                                                   │  │  │
│  │  │  Each trial:                                      │  │  │
│  │  │  1. Create workspace-trial-N/                     │  │  │
│  │  │  2. Copy template files (if any)                  │  │  │
│  │  │  3. Run: kerberosec -y -o "prompt"                     │  │  │
...
│   └──────┬──────┘                                               │
│          │                                                      │
│          │  kerberosec -y -o "prompt" --model <model>                │
│          │                                                      │
│          ▼                                                      │
│   ┌─────────────┐                                               │
│   │   KerberoSec     │                                               │
│   │  Provider   │ ◄─── Uses your KerberoSec auth (kerberosec auth)        │
│   └──────┬──────┘                                               │
│          │                                                      │
│          │ Routes to backend                                    │
│          ▼                                                      │
...
Smoke test CI is temporarily disabled. `.github/workflows/kerberosec-evals-regression.yml` was removed until the build step is repointed at the new SDK CLI.
...
```bash
# Use an installed or locally linked kerberosec binary
