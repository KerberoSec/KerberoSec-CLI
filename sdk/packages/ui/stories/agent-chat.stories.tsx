	...
	<ChatFrame>
		...
		<Message from="assistant">
			...
			<MessageContent>
				...
				<ul className="kerberosec-markdown list-disc pl-5">
	...
	<ChatFrame>
		...
		<Message from="assistant">
			...
			<ToolActivity expandable={false}>
				<ToolActivityTrigger
					icon={<TerminalIcon />}
					label="Running bun -F @kerberosec/ui test"
					status="running"
				/>
			</ToolActivity>
				...
				<ToolActivityContent presentation="rail">
					<ToolActivityCode>
						{status === "error"
							...
							: "@kerberosec/ui theme contract is valid"}
					</ToolActivityCode>
				</ToolActivityContent>
			</ToolActivity>
		))}
		...
		<WorkActivity>
			...
			<WorkActivityContent>
				...
				<ToolActivity expandable={false}>
					<ToolActivityTrigger
						icon={<TerminalIcon />}
						label="Ran bun -F @kerberosec/ui test"
						status="success"
					/>
				</ToolActivity>
			</WorkActivityContent>
 ...
 * `@kerberosec/ui/components/agent-chat/tool-summary` — the same payloads the
