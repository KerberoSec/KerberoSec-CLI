...
// Shown when a request targets a retired kerberosec-free/ model: once its free
...
const KerberoSecFreePromotionEndedError = () => {
	...
	return (
		<div
			...
			data-testid="kerberosec-free-promotion-ended-error">
...
export default KerberoSecFreePromotionEndedError
