 ...
 *
 * A rule in AGENTS.md / .kerberosecrules ("never read .env files") is a suggestion the
 ...
 *
 * CLI usage:
 *   kerberosec plugin install https://github.com/kerberosec/kerberosec/blob/main/sdk/examples/plugins/env-blocker.ts
 *   kerberosec -i "Read the .env file and tell me the API keys"
 */
