...
//   protoc               v3.19.1
// source: kerberosec/models.proto
...
export interface ProviderListing {
   ...
   * `@kerberosec/llms`. When "hide", consumers must suppress per-token pricing
...
export interface KerberoSecRecommendedModelsResponse {
...
export interface ModelsApiSecrets {
  apiKey?: string | undefined;
  kerberosecApiKey?: string | undefined;
  ...
  kerberosecAccountId?: string | undefined;
...
export interface ModelsApiOptions {
  ...
  planModeKerberosecModelId?: string | undefined;
  planModeKerberosecModelInfo?: OpenRouterModelInfo | undefined;
  planModeKerberosecPassModelId?: string | undefined;
  planModeKerberosecPassModelInfo?:
    | OpenRouterModelInfo
    | undefined;
  ...
  actModeKerberosecModelId?: string | undefined;
  actModeKerberosecModelInfo?: OpenRouterModelInfo | undefined;
  actModeKerberosecPassModelId?: string | undefined;
  actModeKerberosecPassModelInfo?: OpenRouterModelInfo | undefined;
}
...
function createBaseModelOverrides(): ModelOverrides {
  return {
    name: undefined,
    maxTokens: undefined,
    contextWindow: undefined,
...
export const ModelOverrides: MessageFns<ModelOverrides> = {
  encode(message: ModelOverrides, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== undefined) {
    ...
    if (message.contextWindow !== undefined) {
      writer.uint32(24).int64(message.contextWindow);
    }
    if (message.maxInputTokens !== undefined) {
      writer.uint32(32).int64(message.maxInputTokens);
    }
    for (const v of message.capabilities) {
      writer.uint32(42).string(v!);
    }
    if (message.supportsVision !== undefined) {
      writer.uint32(48).bool(message.supportsVision);
    }
    if (message.supportsAttachments !== undefined) {
      writer.uint32(56).bool(message.supportsAttachments);
    }
    if (message.supportsReasoning !== undefined) {
      writer.uint32(64).bool(message.supportsReasoning);
    }
    if (message.inputPrice !== undefined) {
      writer.uint32(73).double(message.inputPrice);
    }
    if (message.outputPrice !== undefined) {
      writer.uint32(81).double(message.outputPrice);
    }
    if (message.cacheReadsPrice !== undefined) {
      writer.uint32(89).double(message.cacheReadsPrice);
    }
    if (message.cacheWritesPrice !== undefined) {
      writer.uint32(97).double(message.cacheWritesPrice);
    }
    if (message.temperature !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ModelOverrides {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseModelOverrides();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): ModelOverrides {
    return {
      name: isSet(object.name) ? globalThis.String(object.name) : undefined,
      maxTokens: isSet(object.maxTokens)
        ? globalThis.Number(object.maxTokens)
  ...
  toJSON(message: ModelOverrides): unknown {
    const obj: any = {};
    if (message.name !== undefined) {
      obj.name = message.name;
    }
  ...
  create<I extends Exact<DeepPartial<ModelOverrides>, I>>(base?: I): ModelOverrides {
    return ModelOverrides.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ModelOverrides>, I>>(object: I): ModelOverrides {
    const message = createBaseModelOverrides();
    message.name = object.name ?? undefined;
    message.maxTokens = object.maxTokens ?? undefined;
    message.contextWindow = object.contextWindow ?? undefined;
    message.maxInputTokens = object.maxInputTokens ?? undefined;
    message.capabilities = object.capabilities?.map((e) => e) || [];
    message.supportsVision = object.supportsVision ?? undefined;
    message.supportsAttachments = object.supportsAttachments ?? undefined;
    message.supportsReasoning = object.supportsReasoning ?? undefined;
    message.inputPrice = object.inputPrice ?? undefined;
    message.outputPrice = object.outputPrice ?? undefined;
    message.cacheReadsPrice = object.cacheReadsPrice ?? undefined;
...
export const ProviderConfigResponse: MessageFns<ProviderConfigResponse> = {
  encode(message: ProviderConfigResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.contextWindow !== undefined) {
      writer.uint32(112).int32(message.contextWindow);
    }
    return writer;
  },
...
function createBaseCommittedModelSelection(): CommittedModelSelection {
  return { providerId: "", modelId: "", modelInfo: undefined, overrides: undefined };
}
...
export const CommittedModelSelection: MessageFns<CommittedModelSelection> = {
  encode(message: CommittedModelSelection, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.overrides !== undefined) {
      ModelOverrides.encode(message.overrides, writer.uint32(34).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          ...
          message.overrides = ModelOverrides.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): CommittedModelSelection {
    return {
      ...
      modelInfo: isSet(object.modelInfo)
        ...
        ? OpenRouterModelInfo.fromJSON(object.model_info)
        : undefined,
      overrides: isSet(object.overrides) ? ModelOverrides.fromJSON(object.overrides) : undefined,
    };
  },
  ...
  toJSON(message: CommittedModelSelection): unknown {
    ...
    if (message.overrides !== undefined) {
      obj.overrides = ModelOverrides.toJSON(message.overrides);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<CommittedModelSelection>, I>>(object: I): CommittedModelSelection {
    ...
    message.overrides = (object.overrides !== undefined && object.overrides !== null)
      ? ModelOverrides.fromPartial(object.overrides)
      : undefined;
    return message;
  },
};
...
export const WriteProviderConfigPatch: MessageFns<WriteProviderConfigPatch> = {
  encode(message: WriteProviderConfigPatch, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.contextWindow !== undefined) {
      writer.uint32(104).int32(message.contextWindow);
    }
    return writer;
  },
...
function createBaseCommitModelSelectionRequest(): CommitModelSelectionRequest {
  return { providerId: "", mode: "", modelId: "", overrides: undefined };
}
...
export const CommitModelSelectionRequest: MessageFns<CommitModelSelectionRequest> = {
  encode(message: CommitModelSelectionRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.overrides !== undefined) {
      ModelOverrides.encode(message.overrides, writer.uint32(42).fork()).join();
    }
    return writer;
  },
...
function createBaseKerberoSecRecommendedModel(): KerberoSecRecommendedModel {
  return { id: "", name: "", description: "", tags: [] };
}

export const KerberoSecRecommendedModel: MessageFns<KerberoSecRecommendedModel> = {
  encode(message: KerberoSecRecommendedModel, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.name !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): KerberoSecRecommendedModel {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseKerberoSecRecommendedModel();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): KerberoSecRecommendedModel {
    return {
      id: isSet(object.id) ? globalThis.String(object.id) : "",
      name: isSet(object.name) ? globalThis.String(object.name) : "",
  ...
  toJSON(message: KerberoSecRecommendedModel): unknown {
    const obj: any = {};
    if (message.id !== "") {
      obj.id = message.id;
    }
  ...
  create<I extends Exact<DeepPartial<KerberoSecRecommendedModel>, I>>(base?: I): KerberoSecRecommendedModel {
    return KerberoSecRecommendedModel.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<KerberoSecRecommendedModel>, I>>(object: I): KerberoSecRecommendedModel {
    const message = createBaseKerberoSecRecommendedModel();
    message.id = object.id ?? "";
    message.name = object.name ?? "";
...
function createBaseKerberoSecRecommendedModelsResponse(): KerberoSecRecommendedModelsResponse {
  return { recommended: [], free: [], kerberosecPass: [] };
}

export const KerberoSecRecommendedModelsResponse: MessageFns<KerberoSecRecommendedModelsResponse> = {
  encode(message: KerberoSecRecommendedModelsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.recommended) {
      KerberoSecRecommendedModel.encode(v!, writer.uint32(10).fork()).join();
    }
    for (const v of message.free) {
      KerberoSecRecommendedModel.encode(v!, writer.uint32(18).fork()).join();
    }
    for (const v of message.kerberosecPass) {
      KerberoSecRecommendedModel.encode(v!, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): KerberoSecRecommendedModelsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseKerberoSecRecommendedModelsResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.recommended.push(KerberoSecRecommendedModel.decode(reader, reader.uint32()));
          continue;
        }
        case 2: {
          if (tag !== 18) {
          ...
          message.free.push(KerberoSecRecommendedModel.decode(reader, reader.uint32()));
          continue;
        }
        case 3: {
          if (tag !== 26) {
          ...
          message.kerberosecPass.push(KerberoSecRecommendedModel.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): KerberoSecRecommendedModelsResponse {
    return {
      recommended: globalThis.Array.isArray(object?.recommended)
        ? object.recommended.map((e: any) => KerberoSecRecommendedModel.fromJSON(e))
        : [],
      free: globalThis.Array.isArray(object?.free)
        ? object.free.map((e: any) => KerberoSecRecommendedModel.fromJSON(e))
        : [],
      kerberosecPass: globalThis.Array.isArray(object?.kerberosecPass)
        ? object.kerberosecPass.map((e: any) => KerberoSecRecommendedModel.fromJSON(e))
        : globalThis.Array.isArray(object?.kerberosec_pass)
        ? object.kerberosec_pass.map((e: any) => KerberoSecRecommendedModel.fromJSON(e))
        : [],
    };
  },

  toJSON(message: KerberoSecRecommendedModelsResponse): unknown {
    const obj: any = {};
    if (message.recommended?.length) {
      obj.recommended = message.recommended.map((e) => KerberoSecRecommendedModel.toJSON(e));
    }
    if (message.free?.length) {
      obj.free = message.free.map((e) => KerberoSecRecommendedModel.toJSON(e));
    }
    if (message.kerberosecPass?.length) {
      obj.kerberosecPass = message.kerberosecPass.map((e) => KerberoSecRecommendedModel.toJSON(e));
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<KerberoSecRecommendedModelsResponse>, I>>(
    base?: I,
  ): KerberoSecRecommendedModelsResponse {
    return KerberoSecRecommendedModelsResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<KerberoSecRecommendedModelsResponse>, I>>(
    object: I,
  ): KerberoSecRecommendedModelsResponse {
    const message = createBaseKerberoSecRecommendedModelsResponse();
    message.recommended = object.recommended?.map((e) => KerberoSecRecommendedModel.fromPartial(e)) || [];
    message.free = object.free?.map((e) => KerberoSecRecommendedModel.fromPartial(e)) || [];
    message.kerberosecPass = object.kerberosecPass?.map((e) => KerberoSecRecommendedModel.fromPartial(e)) || [];
    return message;
  },
};

function createBaseOpenAiModelsRequest(): OpenAiModelsRequest {
  return { metadata: undefined, baseUrl: "", apiKey: "", providerId: "" };
}
...
export const ModelsApiSecrets: MessageFns<ModelsApiSecrets> = {
  encode(message: ModelsApiSecrets, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.kerberosecApiKey !== undefined) {
      writer.uint32(18).string(message.kerberosecApiKey);
    }
    ...
    if (message.kerberosecAccountId !== undefined) {
      writer.uint32(226).string(message.kerberosecAccountId);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.kerberosecApiKey = reader.string();
          continue;
        }
        case 3: {
          if (tag !== 26) {
        ...
        case 28: {
          ...
          message.kerberosecAccountId = reader.string();
          continue;
        }
        case 29: {
          if (tag !== 234) {
  ...
  fromJSON(object: any): ModelsApiSecrets {
    return {
      apiKey: isSet(object.apiKey)
        ...
        ? globalThis.String(object.api_key)
        : undefined,
      kerberosecApiKey: isSet(object.kerberosecApiKey)
        ? globalThis.String(object.kerberosecApiKey)
        : isSet(object.kerberosec_api_key)
        ? globalThis.String(object.kerberosec_api_key)
        : undefined,
      ...
      moonshotApiKey: isSet(object.moonshotApiKey)
        ...
        : undefined,
      kerberosecAccountId: isSet(object.kerberosecAccountId)
        ? globalThis.String(object.kerberosecAccountId)
        : isSet(object.kerberosec_account_id)
        ? globalThis.String(object.kerberosec_account_id)
        : undefined,
  ...
  toJSON(message: ModelsApiSecrets): unknown {
    ...
    if (message.kerberosecApiKey !== undefined) {
      obj.kerberosecApiKey = message.kerberosecApiKey;
    }
    if (message.liteLlmApiKey !== undefined) {
    ...
    if (message.kerberosecAccountId !== undefined) {
      obj.kerberosecAccountId = message.kerberosecAccountId;
    }
    if (message.groqApiKey !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<ModelsApiSecrets>, I>>(object: I): ModelsApiSecrets {
    const message = createBaseModelsApiSecrets();
    message.apiKey = object.apiKey ?? undefined;
    message.kerberosecApiKey = object.kerberosecApiKey ?? undefined;
    ...
    message.kerberosecAccountId = object.kerberosecAccountId ?? undefined;
...
function createBaseModelsApiOptions(): ModelsApiOptions {
  return {
    ...
    planModeKerberosecModelId: undefined,
    planModeKerberosecModelInfo: undefined,
    planModeKerberosecPassModelId: undefined,
    planModeKerberosecPassModelInfo: undefined,
    ...
    actModeKerberosecModelId: undefined,
    actModeKerberosecModelInfo: undefined,
    actModeKerberosecPassModelId: undefined,
    actModeKerberosecPassModelInfo: undefined,
  };
}
...
export const ModelsApiOptions: MessageFns<ModelsApiOptions> = {
  encode(message: ModelsApiOptions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.planModeKerberosecModelId !== undefined) {
      writer.uint32(1082).string(message.planModeKerberosecModelId);
    }
    if (message.planModeKerberosecModelInfo !== undefined) {
      OpenRouterModelInfo.encode(message.planModeKerberosecModelInfo, writer.uint32(1090).fork()).join();
    }
    if (message.planModeKerberosecPassModelId !== undefined) {
      writer.uint32(1098).string(message.planModeKerberosecPassModelId);
    }
    if (message.planModeKerberosecPassModelInfo !== undefined) {
      OpenRouterModelInfo.encode(message.planModeKerberosecPassModelInfo, writer.uint32(1106).fork()).join();
    }
    ...
    if (message.actModeKerberosecModelId !== undefined) {
      writer.uint32(1882).string(message.actModeKerberosecModelId);
    }
    if (message.actModeKerberosecModelInfo !== undefined) {
      OpenRouterModelInfo.encode(message.actModeKerberosecModelInfo, writer.uint32(1890).fork()).join();
    }
    if (message.actModeKerberosecPassModelId !== undefined) {
      writer.uint32(1898).string(message.actModeKerberosecPassModelId);
    }
    if (message.actModeKerberosecPassModelInfo !== undefined) {
      OpenRouterModelInfo.encode(message.actModeKerberosecPassModelInfo, writer.uint32(1906).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 135: {
          ...
          message.planModeKerberosecModelId = reader.string();
          continue;
        }
        case 136: {
          if (tag !== 1090) {
          ...
          message.planModeKerberosecModelInfo = OpenRouterModelInfo.decode(reader, reader.uint32());
          continue;
        }
        case 137: {
          if (tag !== 1098) {
          ...
          message.planModeKerberosecPassModelId = reader.string();
          continue;
        }
        case 138: {
          if (tag !== 1106) {
          ...
          message.planModeKerberosecPassModelInfo = OpenRouterModelInfo.decode(reader, reader.uint32());
          continue;
        }
        case 200: {
          if (tag !== 1602) {
        ...
        case 235: {
          ...
          message.actModeKerberosecModelId = reader.string();
          continue;
        }
        case 236: {
          if (tag !== 1890) {
          ...
          message.actModeKerberosecModelInfo = OpenRouterModelInfo.decode(reader, reader.uint32());
          continue;
        }
        case 237: {
          if (tag !== 1898) {
          ...
          message.actModeKerberosecPassModelId = reader.string();
          continue;
        }
        case 238: {
          if (tag !== 1906) {
          ...
          message.actModeKerberosecPassModelInfo = OpenRouterModelInfo.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): ModelsApiOptions {
    return {
      ...
      planModeAihubmixModelInfo: isSet(object.planModeAihubmixModelInfo)
        ...
        : undefined,
      planModeKerberosecModelId: isSet(object.planModeKerberosecModelId)
        ? globalThis.String(object.planModeKerberosecModelId)
        : isSet(object.plan_mode_kerberosec_model_id)
        ? globalThis.String(object.plan_mode_kerberosec_model_id)
        : undefined,
      planModeKerberosecModelInfo: isSet(object.planModeKerberosecModelInfo)
        ? OpenRouterModelInfo.fromJSON(object.planModeKerberosecModelInfo)
        : isSet(object.plan_mode_kerberosec_model_info)
        ? OpenRouterModelInfo.fromJSON(object.plan_mode_kerberosec_model_info)
        : undefined,
      planModeKerberosecPassModelId: isSet(object.planModeKerberosecPassModelId)
        ? globalThis.String(object.planModeKerberosecPassModelId)
        : isSet(object.plan_mode_kerberosec_pass_model_id)
        ? globalThis.String(object.plan_mode_kerberosec_pass_model_id)
        : undefined,
      planModeKerberosecPassModelInfo: isSet(object.planModeKerberosecPassModelInfo)
        ? OpenRouterModelInfo.fromJSON(object.planModeKerberosecPassModelInfo)
        : isSet(object.plan_mode_kerberosec_pass_model_info)
        ? OpenRouterModelInfo.fromJSON(object.plan_mode_kerberosec_pass_model_info)
        : undefined,
      ...
      actModeAihubmixModelInfo: isSet(object.actModeAihubmixModelInfo)
        ...
        : undefined,
      actModeKerberosecModelId: isSet(object.actModeKerberosecModelId)
        ? globalThis.String(object.actModeKerberosecModelId)
        : isSet(object.act_mode_kerberosec_model_id)
        ? globalThis.String(object.act_mode_kerberosec_model_id)
        : undefined,
      actModeKerberosecModelInfo: isSet(object.actModeKerberosecModelInfo)
        ? OpenRouterModelInfo.fromJSON(object.actModeKerberosecModelInfo)
        : isSet(object.act_mode_kerberosec_model_info)
        ? OpenRouterModelInfo.fromJSON(object.act_mode_kerberosec_model_info)
        : undefined,
      actModeKerberosecPassModelId: isSet(object.actModeKerberosecPassModelId)
        ? globalThis.String(object.actModeKerberosecPassModelId)
        : isSet(object.act_mode_kerberosec_pass_model_id)
        ? globalThis.String(object.act_mode_kerberosec_pass_model_id)
        : undefined,
      actModeKerberosecPassModelInfo: isSet(object.actModeKerberosecPassModelInfo)
        ? OpenRouterModelInfo.fromJSON(object.actModeKerberosecPassModelInfo)
        : isSet(object.act_mode_kerberosec_pass_model_info)
        ? OpenRouterModelInfo.fromJSON(object.act_mode_kerberosec_pass_model_info)
        : undefined,
    };
  },
  ...
  toJSON(message: ModelsApiOptions): unknown {
    ...
    if (message.planModeKerberosecModelId !== undefined) {
      obj.planModeKerberosecModelId = message.planModeKerberosecModelId;
    }
    if (message.planModeKerberosecModelInfo !== undefined) {
      obj.planModeKerberosecModelInfo = OpenRouterModelInfo.toJSON(message.planModeKerberosecModelInfo);
    }
    if (message.planModeKerberosecPassModelId !== undefined) {
      obj.planModeKerberosecPassModelId = message.planModeKerberosecPassModelId;
    }
    if (message.planModeKerberosecPassModelInfo !== undefined) {
      obj.planModeKerberosecPassModelInfo = OpenRouterModelInfo.toJSON(message.planModeKerberosecPassModelInfo);
    }
    if (message.actModeApiProvider !== undefined) {
    ...
    if (message.actModeKerberosecModelId !== undefined) {
      obj.actModeKerberosecModelId = message.actModeKerberosecModelId;
    }
    if (message.actModeKerberosecModelInfo !== undefined) {
      obj.actModeKerberosecModelInfo = OpenRouterModelInfo.toJSON(message.actModeKerberosecModelInfo);
    }
    if (message.actModeKerberosecPassModelId !== undefined) {
      obj.actModeKerberosecPassModelId = message.actModeKerberosecPassModelId;
    }
    if (message.actModeKerberosecPassModelInfo !== undefined) {
      obj.actModeKerberosecPassModelInfo = OpenRouterModelInfo.toJSON(message.actModeKerberosecPassModelInfo);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ModelsApiOptions>, I>>(object: I): ModelsApiOptions {
    ...
    message.planModeAihubmixModelInfo =
      (object.planModeAihubmixModelInfo !== undefined && object.planModeAihubmixModelInfo !== null)
        ...
        : undefined;
    message.planModeKerberosecModelId = object.planModeKerberosecModelId ?? undefined;
    message.planModeKerberosecModelInfo =
      (object.planModeKerberosecModelInfo !== undefined && object.planModeKerberosecModelInfo !== null)
        ? OpenRouterModelInfo.fromPartial(object.planModeKerberosecModelInfo)
        : undefined;
    message.planModeKerberosecPassModelId = object.planModeKerberosecPassModelId ?? undefined;
    message.planModeKerberosecPassModelInfo =
      (object.planModeKerberosecPassModelInfo !== undefined && object.planModeKerberosecPassModelInfo !== null)
        ? OpenRouterModelInfo.fromPartial(object.planModeKerberosecPassModelInfo)
        : undefined;
    ...
    message.actModeAihubmixModelInfo =
      (object.actModeAihubmixModelInfo !== undefined && object.actModeAihubmixModelInfo !== null)
        ...
        : undefined;
    message.actModeKerberosecModelId = object.actModeKerberosecModelId ?? undefined;
    message.actModeKerberosecModelInfo =
      (object.actModeKerberosecModelInfo !== undefined && object.actModeKerberosecModelInfo !== null)
        ? OpenRouterModelInfo.fromPartial(object.actModeKerberosecModelInfo)
        : undefined;
    message.actModeKerberosecPassModelId = object.actModeKerberosecPassModelId ?? undefined;
    message.actModeKerberosecPassModelInfo =
      (object.actModeKerberosecPassModelInfo !== undefined && object.actModeKerberosecPassModelInfo !== null)
        ? OpenRouterModelInfo.fromPartial(object.actModeKerberosecPassModelInfo)
        : undefined;
    return message;
  },
};
...
export const ModelsApiConfiguration: MessageFns<ModelsApiConfiguration> = {
  encode(message: ModelsApiConfiguration, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.kerberosecAccountId !== undefined) {
      writer.uint32(482).string(message.kerberosecAccountId);
    }
    if (message.groqApiKey !== undefined) {
    ...
    if (message.planModeKerberosecModelId !== undefined) {
      writer.uint32(1122).string(message.planModeKerberosecModelId);
    }
    if (message.planModeKerberosecModelInfo !== undefined) {
      OpenRouterModelInfo.encode(message.planModeKerberosecModelInfo, writer.uint32(1130).fork()).join();
    }
    if (message.planModeKerberosecPassModelId !== undefined) {
      writer.uint32(1138).string(message.planModeKerberosecPassModelId);
    }
    if (message.planModeKerberosecPassModelInfo !== undefined) {
      OpenRouterModelInfo.encode(message.planModeKerberosecPassModelInfo, writer.uint32(1146).fork()).join();
    }
    if (message.actModeApiProvider !== undefined) {
      writer.uint32(1602).string(message.actModeApiProvider);
    }
    ...
    if (message.actModeKerberosecModelId !== undefined) {
      writer.uint32(1922).string(message.actModeKerberosecModelId);
    }
    if (message.actModeKerberosecModelInfo !== undefined) {
      OpenRouterModelInfo.encode(message.actModeKerberosecModelInfo, writer.uint32(1930).fork()).join();
    }
    if (message.actModeKerberosecPassModelId !== undefined) {
      writer.uint32(1938).string(message.actModeKerberosecPassModelId);
    }
    if (message.actModeKerberosecPassModelInfo !== undefined) {
      OpenRouterModelInfo.encode(message.actModeKerberosecPassModelInfo, writer.uint32(1946).fork()).join();
    }
    return writer;
  },
...
export const ModelsServiceDefinition = {
  name: "ModelsService",
  fullName: "kerberosec.ModelsService",
  methods: {
    ...
    /** Refreshes and returns recommended and free KerberoSec models */
    refreshKerberoSecRecommendedModelsRpc: {
      name: "refreshKerberoSecRecommendedModelsRpc",
      requestType: EmptyRequest as typeof EmptyRequest,
      requestStream: false,
      responseType: KerberoSecRecommendedModelsResponse as typeof KerberoSecRecommendedModelsResponse,
      responseStream: false,
      options: {},
    },
...
export const ModelsServiceService = {
  /** Fetches available models from Ollama */
  getOllamaModels: {
    path: "/kerberosec.ModelsService/getOllamaModels" as const,
  ...
  /** Fetches available models from LM Studio */
  getLmStudioModels: {
    path: "/kerberosec.ModelsService/getLmStudioModels" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: StringRequest): Buffer => Buffer.from(StringRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): StringRequest => StringRequest.decode(value),
  ...
  /** Fetches available models from VS Code LM API */
  getVsCodeLmModels: {
    path: "/kerberosec.ModelsService/getVsCodeLmModels" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Refreshes and returns OpenRouter models */
  refreshOpenRouterModelsRpc: {
    path: "/kerberosec.ModelsService/refreshOpenRouterModelsRpc" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
  ...
  /** Refreshes and returns recommended and free KerberoSec models */
  refreshKerberoSecRecommendedModelsRpc: {
    path: "/kerberosec.ModelsService/refreshKerberoSecRecommendedModelsRpc" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
    responseSerialize: (value: KerberoSecRecommendedModelsResponse): Buffer =>
      Buffer.from(KerberoSecRecommendedModelsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): KerberoSecRecommendedModelsResponse =>
      KerberoSecRecommendedModelsResponse.decode(value),
  },
  /** Refreshes and returns Hugging Face models */
  refreshHuggingFaceModels: {
    path: "/kerberosec.ModelsService/refreshHuggingFaceModels" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
  ...
  /** Refreshes and returns OpenAI models */
  refreshOpenAiModels: {
    path: "/kerberosec.ModelsService/refreshOpenAiModels" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Refreshes and returns Requesty models */
  refreshRequestyModels: {
    path: "/kerberosec.ModelsService/refreshRequestyModels" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
  ...
  /** Refreshes and returns Hicap models */
  refreshHicapModels: {
    path: "/kerberosec.ModelsService/refreshHicapModels" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
  ...
  /** Refreshes and returns LiteLLM models */
  refreshLiteLlmModelsRpc: {
    path: "/kerberosec.ModelsService/refreshLiteLlmModelsRpc" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
  ...
  /** Subscribe to OpenRouter models updates */
  subscribeToOpenRouterModels: {
    path: "/kerberosec.ModelsService/subscribeToOpenRouterModels" as const,
    requestStream: false as const,
  ...
  /** Subscribe to LiteLLM models updates */
  subscribeToLiteLlmModels: {
    path: "/kerberosec.ModelsService/subscribeToLiteLlmModels" as const,
    requestStream: false as const,
    responseStream: true as const,
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
  ...
  /** Updates API configuration (legacy - uses combined configuration) */
  updateApiConfigurationProto: {
    path: "/kerberosec.ModelsService/updateApiConfigurationProto" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Updates API configuration (new - uses separate options and secrets) */
  updateApiConfiguration: {
    path: "/kerberosec.ModelsService/updateApiConfiguration" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Updates API configuration with partial values (only updates fields that are explicitly set) */
  updateApiConfigurationPartial: {
    path: "/kerberosec.ModelsService/updateApiConfigurationPartial" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Refreshes and returns Groq models */
  refreshGroqModelsRpc: {
    path: "/kerberosec.ModelsService/refreshGroqModelsRpc" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
  ...
  /** Refreshes and returns Baseten models */
  refreshBasetenModelsRpc: {
    path: "/kerberosec.ModelsService/refreshBasetenModelsRpc" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
  ...
  /** Fetches available models from SAP AI Core */
  getSapAiCoreModels: {
    path: "/kerberosec.ModelsService/getSapAiCoreModels" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Fetches available models from OCA */
  refreshOcaModels: {
    path: "/kerberosec.ModelsService/refreshOcaModels" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: StringRequest): Buffer => Buffer.from(StringRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): StringRequest => StringRequest.decode(value),
  ...
  /** Fetches available models from AIhubmix */
  getAihubmixModels: {
    path: "/kerberosec.ModelsService/getAihubmixModels" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
  ...
  /** Refreshes and returns Vercel AI Gateway models */
  refreshVercelAiGatewayModelsRpc: {
    path: "/kerberosec.ModelsService/refreshVercelAiGatewayModelsRpc" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
  ...
  /** Lists providers available from the unified SDK-backed catalog */
  listProviders: {
    path: "/kerberosec.ModelsService/listProviders" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Resolves model metadata for a provider through the unified SDK-backed catalog */
  resolveProviderModels: {
    path: "/kerberosec.ModelsService/resolveProviderModels" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Resolves model metadata for a provider/model without refreshing model lists */
  resolveModelInfo: {
    path: "/kerberosec.ModelsService/resolveModelInfo" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Reads redacted effective provider configuration */
  readProviderConfig: {
    path: "/kerberosec.ModelsService/readProviderConfig" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: StringRequest): Buffer => Buffer.from(StringRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): StringRequest => StringRequest.decode(value),
  ...
  /** Writes provider configuration fields and returns redacted effective configuration */
  writeProviderConfig: {
    path: "/kerberosec.ModelsService/writeProviderConfig" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Commits a mode-specific model ID with optional user-authored metadata overrides */
  commitModelSelection: {
    path: "/kerberosec.ModelsService/commitModelSelection" as const,
    requestStream: false as const,
    responseStream: false as const,
...
export interface ModelsServiceServer extends UntypedServiceImplementation {
  ...
  /** Refreshes and returns recommended and free KerberoSec models */
  refreshKerberoSecRecommendedModelsRpc: handleUnaryCall<EmptyRequest, KerberoSecRecommendedModelsResponse>;
  /** Refreshes and returns Hugging Face models */
...
export interface ModelsServiceClient extends Client {
  ...
  refreshKerberoSecRecommendedModelsRpc(
    request: EmptyRequest,
    callback: (error: ServiceError | null, response: KerberoSecRecommendedModelsResponse) => void,
  ): ClientUnaryCall;
  refreshKerberoSecRecommendedModelsRpc(
    request: EmptyRequest,
    metadata: Metadata,
