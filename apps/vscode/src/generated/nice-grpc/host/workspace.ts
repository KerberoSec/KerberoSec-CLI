...
import { FileDiagnostics, Metadata } from "../kerberosec/common";
...
export const OpenKerberoSecSidebarPanelRequest: MessageFns<OpenKerberoSecSidebarPanelRequest> = {
  ...
  create(base?: DeepPartial<OpenKerberoSecSidebarPanelRequest>): OpenKerberoSecSidebarPanelRequest {
    return OpenKerberoSecSidebarPanelRequest.fromPartial(base ?? {});
  },
  fromPartial(_: DeepPartial<OpenKerberoSecSidebarPanelRequest>): OpenKerberoSecSidebarPanelRequest {
    const message = createBaseOpenKerberoSecSidebarPanelRequest();
    return message;
  },
};
...
export const OpenKerberoSecSidebarPanelResponse: MessageFns<OpenKerberoSecSidebarPanelResponse> = {
  ...
  create(base?: DeepPartial<OpenKerberoSecSidebarPanelResponse>): OpenKerberoSecSidebarPanelResponse {
    return OpenKerberoSecSidebarPanelResponse.fromPartial(base ?? {});
  },
  fromPartial(_: DeepPartial<OpenKerberoSecSidebarPanelResponse>): OpenKerberoSecSidebarPanelResponse {
    const message = createBaseOpenKerberoSecSidebarPanelResponse();
    return message;
  },
};
...
export interface WorkspaceServiceImplementation<CallContextExt = {}> {
  ...
  openKerberoSecSidebarPanel(
    ...
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<OpenKerberoSecSidebarPanelResponse>>;
  /** Opens and focuses the terminal panel. */
  openTerminalPanel(
...
export interface WorkspaceServiceClient<CallOptionsExt = {}> {
  ...
  /** Opens and focuses the KerberoSec sidebar panel in the host IDE. */
  openKerberoSecSidebarPanel(
    request: DeepPartial<OpenKerberoSecSidebarPanelRequest>,
    options?: CallOptions & CallOptionsExt,
