...
title: "Agent"
sidebarTitle: "Agent"
description: "API reference for Agent / AgentRuntime from @kerberosec/agents."
---

`Agent` is an alias for `AgentRuntime` from `@kerberosec/agents`.

```typescript
import { Agent, AgentRuntime, createAgent, createAgentRuntime } from "@kerberosec/sdk"
```
