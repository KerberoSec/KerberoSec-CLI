// Registers the VS Code Language Model handler with the KerberoSec SDK.
//
// The SDK's `@kerberosec/llms` factory registry (registerHandler) exists for
...
import { type ModelCollection, registerHandler, registerProvider } from "@kerberosec/llms"
