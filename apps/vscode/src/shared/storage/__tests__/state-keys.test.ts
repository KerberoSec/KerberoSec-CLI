...
describe("State Keys Type Safety", () => {
	...
	describe("Type Exports", () => {
		...
		it("should export usable key types", () => {
			...
			const localKey: LocalStateKey = "localKerberoSecRulesToggles"
		...
		it("should have LocalState keys map to KerberoSecRulesToggles", () => {
			const localState: Partial<LocalState> = {
				localKerberoSecRulesToggles: {},
				localCursorRulesToggles: { "some-rule": true },
			}
			expect(localState.localKerberoSecRulesToggles).to.deep.equal({})
		})
	})
	...
	describe("Edge Cases", () => {
		...
		it("should handle keys with special characters", () => {
			// The kerberosec:kerberosecAccountId key has a colon
			expect(SecretKeys).to.include("kerberosec:kerberosecAccountId")
			expect(isSecretKey("kerberosec:kerberosecAccountId")).to.be.true
		})
