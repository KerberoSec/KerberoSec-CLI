...
const primitivePageDetails = {
	...
	skill: {
		title: "Skills",
		description: "Install skills globally for KerberoSec.",
...
const directoryPageDetails: MarketplacePageDetails = {
	title: "Marketplace",
	description:
		"A curated set of plugins, MCP servers, and skills from the KerberoSec community.",
...
const primitiveCommands = {
	...
	plugin: "kerberosec plugin install",
	skill: "kerberosec skill add",
			...
			{requiredEnv.length > 0 || optionalEnv.length > 0 ? (
				<div className="rounded-lg border border-amber-500/30 bg-amber-500/10 p-3">
					...
					<p className="mt-1 text-xs leading-5 text-amber-800/80 dark:text-amber-100/80">
						Add these values to your KerberoSec/plugin environment after
						install.
					</p>
