...
/**
 * Blocking prompt shown when the sidecar reports that another KerberoSec
 * installation (for example an updated CLI) replaced the shared KerberoSec Hub
...
export function HubUpdateRequiredDialog() {
	...
	return (
		...
		>
			<AlertDialogContent>
				<AlertDialogHeader>
					<AlertDialogTitle>KerberoSec Hub was updated</AlertDialogTitle>
					<AlertDialogDescription>
						Another KerberoSec installation updated the shared KerberoSec Hub
						{mismatch?.hubCoreVersion
							? ` (core ${mismatch.hubCoreVersion})`
							: ""}
						, and it no longer matches this app. Update and restart KerberoSec
