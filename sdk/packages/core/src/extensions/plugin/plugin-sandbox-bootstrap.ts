...
// Keep this local mirror in sync with AgentExtensionCommandResult from @kerberosec/shared.
...
(globalThis as Record<string, unknown>).__kerberosecPluginHost = { emitEvent };
 ...
 */
(globalThis as Record<string, unknown>).__kerberosecSessionEnv = {
...
async function initialize(args: {
	...
	const sessionEnv = (globalThis as Record<string, unknown>)
		.__kerberosecSessionEnv as Record<string, unknown>;
	if (sessionEnv) {
