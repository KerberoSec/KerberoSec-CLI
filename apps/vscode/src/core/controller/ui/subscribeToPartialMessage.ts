...
import { KerberoSecMessage } from "@shared/proto/kerberosec/ui"
import { Logger } from "@/shared/services/Logger"
import { getRequestRegistry, StreamingResponseHandler } from "../grpc-handler"
import { Controller } from "../index"

// Keep track of active partial message subscriptions (gRPC streams)
const activePartialMessageSubscriptions = new Set<StreamingResponseHandler<KerberoSecMessage>>()

// Keep track of callback-based subscriptions (for CLI and other non-gRPC consumers)
type PartialMessageCallback = (message: KerberoSecMessage) => void
...
export async function subscribeToPartialMessage(
	...
	responseStream: StreamingResponseHandler<KerberoSecMessage>,
	requestId?: string,
): Promise<void> {
 ...
 * @param partialMessage The KerberoSecMessage to send
 */
export async function sendPartialMessageEvent(partialMessage: KerberoSecMessage): Promise<void> {
