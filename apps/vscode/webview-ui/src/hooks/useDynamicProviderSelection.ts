 ...
 * Dynamic-list providers (openrouter, kerberosec, openai-compatible, ollama,
...
const FALLBACK_INFO_BY_PROVIDER: Partial<Record<string, ModelInfo>> = {
	...
	kerberosec: openRouterDefaultModelInfo,
...
export function useDynamicProviderSelection(
	...
	return useMemo(() => {
		...
		switch (providerId) {
			...
			case "kerberosec":
				return resolve(fields.kerberosecModelId, fields.kerberosecModelInfo)
