...
export interface SdkSessionHost {
	...
	list(limit?: number, options?: Omit<KerberoSecCoreListHistoryOptions, "limit">): Promise<SessionHistoryRecord[]>
	listHistory(options?: KerberoSecCoreListHistoryOptions): Promise<SessionHistoryRecord[]>
