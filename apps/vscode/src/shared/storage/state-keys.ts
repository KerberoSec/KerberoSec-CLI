...
// executed automatically to regenerate the proto/kerberosec/state.proto file with the
...
const GLOBAL_STATE_FIELDS = {
	kerberosecVersion: { default: undefined as string | undefined },
	"kerberosec.generatedMachineId": { default: undefined as string | undefined }, // Note, distinctId reads/writes this directly from/to StorageContext before StateManager is initialized.
	...
	remoteRulesToggles: { default: {} as KerberoSecRulesToggles },
	remoteWorkflowToggles: { default: {} as KerberoSecRulesToggles },
	remoteSkillsToggles: { default: {} as KerberoSecRulesToggles },
	dismissedBanners: { default: [] as Array<{ bannerId: string; dismissedAt: number }> },
	// Path to worktree that should auto-open KerberoSec sidebar when launched
...
const API_HANDLER_SETTINGS_FIELDS = {
	...
	planModeKerberoSecModelId: { default: undefined as string | undefined },
	planModeKerberoSecModelInfo: { default: undefined as ModelInfo | undefined },
	planModeKerberoSecPassModelId: { default: undefined as string | undefined },
	planModeKerberoSecPassModelInfo: { default: undefined as ModelInfo | undefined },
	...
	actModeKerberoSecModelId: { default: undefined as string | undefined },
	actModeKerberoSecModelInfo: { default: undefined as ModelInfo | undefined },
	actModeKerberoSecPassModelId: { default: undefined as string | undefined },
	actModeKerberoSecPassModelInfo: { default: undefined as ModelInfo | undefined },
...
const USER_SETTINGS_FIELDS = {
	...
	globalKerberoSecRulesToggles: { default: {} as KerberoSecRulesToggles },
	globalWorkflowToggles: { default: {} as KerberoSecRulesToggles },
...
const SECRETS_KEYS = [
	"apiKey",
	"kerberosecApiKey",
	"kerberosecAccountId", // KerberoSec Account ID for Firebase
	"kerberosec:kerberosecAccountId",
	"openRouterApiKey",
	"awsAccessKey",
	"awsSecretKey",
	"awsSessionToken",
...
export type LocalState = { [K in (typeof LocalStateKeys)[number]]: KerberoSecRulesToggles }
