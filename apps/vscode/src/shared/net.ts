/**
 * # Network Support for KerberoSec
 *
 ...
 * ## Proxy Support
 *
 * KerberoSec uses platform-specific fetch implementations to handle proxy
 * configuration:
 ...
 *
 * The CLI's npm wrapper (bin/kerberosec) does the same automatically: it harvests
 ...
 * 3. View logs: Check ~/.kerberosec/kerberosec-core-service.log for network-related
 *    failures.
