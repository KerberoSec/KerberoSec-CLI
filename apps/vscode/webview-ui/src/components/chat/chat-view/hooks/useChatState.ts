 ...
 */
export function useChatState(messages: KerberoSecMessage[]): ChatState {
	...
	const kerberosecAsk = useMemo(() => (lastMessage?.type === "ask" ? lastMessage.ask : undefined), [lastMessage])
