...
// ProviderSettingsManager.write). Concurrent KerberoSec processes (CLI, extension,
...
/**
 * Apply a single provider's updated models.json entry to the live @kerberosec/llms
...
/**
 * Load models.json into the @kerberosec/llms registry at most once per path per
