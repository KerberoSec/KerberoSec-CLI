...
- [Shared Configuration in KerberoSec](#shared-configuration-in-kerberosec)
- [Providers](#providers)
  - [AIHubMix](#aihubmix)
  - [AskSage](#asksage)
  - [Baseten](#baseten)
...
## Shared Configuration in KerberoSec

1. Open KerberoSec settings (⚙️).
...
For the full auth flow (IDE + CLI), see [Authorization & Model Selection](/getting-started/authorizing-with-kerberosec#menu).
...
3. In KerberoSec, choose **AIHubMix** and paste the key.
...
3. In KerberoSec, select **AskSage** and enter the key.
...
3. In KerberoSec, choose **Baseten** and paste the key.
...
3. In KerberoSec, select **Cerebras** and enter the key.
...
3. In KerberoSec, select **Dify.ai** and paste your key.
...
3. In KerberoSec, select **Doubao** and paste credentials.
...
3. In KerberoSec, choose **Fireworks AI** and enter the key.
...
3. In KerberoSec, select **GCP Vertex AI** and provide required config values.
...
2. Create an API key.
3. In KerberoSec, select **Groq** and paste the key.
...
3. In KerberoSec, choose **Hicap** and enter the credential.
...
3. In KerberoSec, select **Huawei Cloud MaaS** and add credentials.
...
3. In KerberoSec, select **Hugging Face** and paste the token.
...
3. In KerberoSec, choose **Mistral** and paste the key.
...
3. In KerberoSec, select **Moonshot** and enter the key.
...
3. In KerberoSec, choose **Nebius AI Studio** and provide the credential.
...
3. In KerberoSec, select **NousResearch** and add credentials.
...
3. In KerberoSec, select **Qwen Code** and enter the credential.
...
2. Generate an API key.
3. In KerberoSec, select **Requesty** and paste the key.
...
3. In KerberoSec, choose **SambaNova** and enter credentials.
...
3. In KerberoSec, select **SAP AI Core** and provide required values.
...
2. Generate an API key.
3. In KerberoSec, choose **Together** and paste the key.
...
3. In KerberoSec, select **Vercel AI Gateway** and add the key.

### VS Code Language Model API
VS Code Language Model API support lets KerberoSec use models exposed by the VS Code host environment.
...
3. In KerberoSec, select **VS Code Language Model API**.
...
2. Generate an API key.
3. In KerberoSec, choose **xAI (Grok)** and paste the key.