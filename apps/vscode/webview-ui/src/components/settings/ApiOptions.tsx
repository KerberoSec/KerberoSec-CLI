...
import { KerberoSecPassProvider } from "./providers/KerberoSecPassProvider"
import { KerberoSecProvider } from "./providers/KerberoSecProvider"
	...
	*/
	...
	return (
		<div
			...
			{apiConfiguration && selectedProvider === "kerberosec" && (
				<KerberoSecProvider
			...
			{apiConfiguration && selectedProvider === "kerberosec-pass" && (
				<KerberoSecPassProvider currentMode={currentMode} isPopup={isPopup} showModelOptions={showModelOptions} />
			)}
