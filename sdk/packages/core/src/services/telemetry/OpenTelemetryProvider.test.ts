...
describe("createOpenTelemetryTelemetryService", () => {
	...
	it("does not create configured telemetry when globally opted out", () => {
		...
		telemetry.updateMetadata({ kerberosec_type: "cli-updated" });
	...
	it("propagates updateMetadata to OTEL logger output", async () => {
		...
		telemetry.updateMetadata({ kerberosec_type: "kanban-updated" });
		...
		expect(emittedAttributes.kerberosec_type).toBe("kanban-updated");
