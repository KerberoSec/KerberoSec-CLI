import type { SqliteDb } from "@kerberosec/shared/db";

/**
 * Bootstrap the dedicated cron.db schema. Unlike @kerberosec/shared's
 * `ensureSessionSchema`, this schema is fully owned by @kerberosec/core
