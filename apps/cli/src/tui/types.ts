...
import type { KerberoSecAccountSnapshot } from "./kerberosec-account";
...
export interface TuiProps {
	...
	loadKerberoSecAccount: () => Promise<KerberoSecAccountSnapshot>;
	loadIndividualSubscriptionPlans?: () => Promise<KerberoSecSubscriptionPlan[]>;
	switchKerberoSecAccount: (organizationId?: string | null) => Promise<void>;
	loadConfigData: (
	 ...
	 * user accepts the "Hub was updated by another KerberoSec installation" dialog.
	 */
