...
describe("SessionStatus", () => {
	it("uses hidden content as dot-only status text without duplicating it", () => {
		...
		expect(markup).toContain("kerberosec-ui-session-status--running");
		expect(markup).toContain("kerberosec-ui-sr-only");
	...
	it("shows the label by default", () => {
		...
		expect(markup).not.toContain("kerberosec-ui-sr-only");
