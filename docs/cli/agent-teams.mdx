...
```bash
kerberosec --team-name auth-sprint "Continue with incomplete tasks"
```
...
Team state is stored at `~/.kerberosec/data/teams/[team-name]/` and includes:
...
```bash
kerberosec --no-teams "your prompt"
```
