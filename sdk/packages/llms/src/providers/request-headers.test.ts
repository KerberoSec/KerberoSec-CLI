...
describe("resolveProviderRequestHeaders", () => {
	it("adds required KerberoSec billing headers after stored, config, and session layers", () => {
	...
	it("uses host client context for KerberoSec billing headers when provided", () => {
		const headers = resolveProviderRequestHeaders({
