...
4. KerberoSec will use your default Google Cloud credentials automatically
</Accordion>
...
4. KerberoSec will automatically detect credentials from your environment
</Accordion>
</AccordionGroup>
...
Send a test message in KerberoSec to verify your credentials work correctly with the configured Vertex AI project and region.
...
- **Image Analysis**: Upload images directly in KerberoSec for analysis
...
Confirm you're signed into the correct KerberoSec organization. Verify your administrator has saved the Vertex AI configuration and that you have the latest version of the KerberoSec extension.
