...
/**
 * KerberoSecLogoVariable component renders the KerberoSec logo with automatic theme adaptation
 ...
 * @returns {JSX.Element} SVG KerberoSec logo that adapts to VS Code themes and environment
 */
const KerberoSecLogoVariable = (props: SVGProps<SVGSVGElement> & { environment?: Environment }) => {
...
export default KerberoSecLogoVariable
