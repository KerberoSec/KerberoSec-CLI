 ...
 *
 * Use cases:
 * - Global hooks directory: ~/Documents/KerberoSec/Hooks/
 * - Workspace hooks: /path/to/My Project/.kerberosecrules/hooks/
 * - Multi-root workspaces: each root's .kerberosecrules/hooks/
 *
 * Examples:
