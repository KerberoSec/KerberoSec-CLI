...
export const WebServiceDefinition = {
  name: "WebService",
  fullName: "kerberosec.WebService",
  methods: {
    checkIsImageUrl: {
...
export const WebServiceService = {
  checkIsImageUrl: {
    path: "/kerberosec.WebService/checkIsImageUrl" as const,
  ...
  fetchOpenGraphData: {
    path: "/kerberosec.WebService/fetchOpenGraphData" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: StringRequest): Buffer => Buffer.from(StringRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): StringRequest => StringRequest.decode(value),
  ...
  openInBrowser: {
    path: "/kerberosec.WebService/openInBrowser" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: StringRequest): Buffer => Buffer.from(StringRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): StringRequest => StringRequest.decode(value),
...
export const WebServiceClient = makeGenericClientConstructor(WebServiceService, "kerberosec.WebService") as unknown as {
