...
export interface StateServiceImplementation<CallContextExt = {}> {
  ...
  installKerberoSecCli(request: EmptyRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
...
export interface StateServiceClient<CallOptionsExt = {}> {
  ...
  installKerberoSecCli(request: DeepPartial<EmptyRequest>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
