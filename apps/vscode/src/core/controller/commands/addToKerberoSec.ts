...
// 'Add to KerberoSec' context menu in editor and code action
// Inserts the selected code into the chat.
export async function addToKerberoSec(controller: Controller, request: CommandContext, notebookContext?: string): Promise<Empty> {
	...
	Logger.log("addToKerberoSec", request.selectedText, filePath, request.language)
