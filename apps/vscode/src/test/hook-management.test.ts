...
import { CreateHookRequest, DeleteHookRequest, ToggleHookRequest } from "../shared/proto/kerberosec/file"
...
describe("Hook Management", () => {
	...
	beforeEach(async () => {
		...
		globalHooksDir = path.join(tempDir, "global", "Documents", "KerberoSec", "Hooks")
		workspaceHooksDir = path.join(tempDir, "workspace", ".kerberosecrules", "hooks")
	...
	describe("Edge Cases", () => {
		it("should handle missing .kerberosecrules directory gracefully", async () => {
