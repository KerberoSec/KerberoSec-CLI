...
description: "API reference for KerberoSecCore from @kerberosec/core."
---
...
| `automation` | `boolean \| KerberoSecCoreAutomationOptions` | Enable automation APIs |
...
When `automation` is enabled, use `kerberosec.automation` to start/stop automation services, reconcile specs, ingest events, and list events/specs/runs.
