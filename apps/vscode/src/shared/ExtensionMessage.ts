...
import type { GeneratedMedia } from "@kerberosec/shared"
...
import { KerberoSecFeatureSetting } from "./KerberoSecFeatureSetting"
import { BannerCardData } from "./kerberosec/banner"
import { KerberoSecRulesToggles } from "./kerberosec-rules"
import { HistoryItem } from "./HistoryItem"
import { McpDisplayMode } from "./McpDisplayMode"
import { KerberoSecMessageModelInfo } from "./messages"
import { OnboardingModelGroup } from "./proto/kerberosec/state"
...
export const COMMAND_CANCEL_TOKEN = "__kerberosec_command_cancel__"
export interface ExtensionState {
	 ...
	 * renders the footer/buttons/thinking indicator from this, NOT from the tail of kerberosecMessages.
	...
	stateVersion?: number
	/**
	 * Conversation/replica fence for this snapshot (see KerberoSecMessage.epoch). A snapshot with a
	...
	distinctId: string
	globalKerberoSecRulesToggles: KerberoSecRulesToggles
	localKerberoSecRulesToggles: KerberoSecRulesToggles
	localWorkflowToggles: KerberoSecRulesToggles
	globalWorkflowToggles: KerberoSecRulesToggles
	localCursorRulesToggles: KerberoSecRulesToggles
	localWindsurfRulesToggles: KerberoSecRulesToggles
	remoteRulesToggles?: KerberoSecRulesToggles
	remoteWorkflowToggles?: KerberoSecRulesToggles
	localAgentsRulesToggles: KerberoSecRulesToggles
	mcpResponsesCollapsed?: boolean
	useAutoCondense?: boolean
	compactionStrategy?: string
	webSearchEnabled?: boolean
	subagentsEnabled?: boolean
	worktreesEnabled?: KerberoSecFeatureSetting
	favoritedModelIds: string[]
	// NEW: Add workspace information
	workspaceRoots: WorkspaceRoot[]
	primaryRootIndex: number
	isMultiRootWorkspace: boolean
	multiRootSetting: KerberoSecFeatureSetting
 ...
 * this instead of inferring mode from the tail of kerberosecMessages.
 */
...
export interface TurnState {
	phase: TurnPhase
	/** ts of the KerberoSecMessage this phase is "about" (e.g. the pending approval/ask). */
	anchorTs?: number
...
export interface KerberoSecSaySubagentStatus {
...
export interface KerberoSecAskUseSubagents {
	prompts: string[]
}
 ...
 */
export interface KerberoSecCompactionInfo {
...
export interface KerberoSecSubagentUsageInfo {
	source: "subagents"
	tokensIn: number
	tokensOut: number
	cacheWrites: number
...
type KerberoSecApiReqCancelReason = "streaming_failed" | "user_cancelled" | "retries_exhausted"
