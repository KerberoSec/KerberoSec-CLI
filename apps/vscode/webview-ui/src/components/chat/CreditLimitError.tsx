...
const DEFAULT_BUY_CREDITS_URL = {
	USER: "https://app.kerberosec.bot/dashboard/account?tab=credits&redirect=true",
	ORG: "https://app.kerberosec.bot/dashboard/organization?tab=credits&redirect=true",
}
...
const CreditLimitError: React.FC<CreditLimitErrorProps> = ({
	...
	const { activeOrganization } = useKerberoSecAuth()
