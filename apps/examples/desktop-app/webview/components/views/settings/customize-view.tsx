 ...
 * KerberoSec — skills, MCP servers, plugins, rules, hooks, and tools — as sub-tabs
	...
	return (
		<PageFrame>
			<PageHeader
				...
				description="Extend what KerberoSec can do and change how it works. Manage what's installed, or browse the marketplace for more options."
				title="Customize"
			/>
