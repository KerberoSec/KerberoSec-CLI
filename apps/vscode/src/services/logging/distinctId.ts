 ...
 * Unlike the distinct ID, this is never replaced by the KerberoSec User ID on auth,
 ...
 */
export const _GENERATED_MACHINE_ID_KEY = "kerberosec.generatedMachineId"
 ...
 * This is updated to KerberoSec User ID when authenticated.
 */
 ...
 * If authenticated, this will be the KerberoSec User ID.
