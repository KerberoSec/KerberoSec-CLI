...
declare const __KERBEROSEC_CORE_RUNTIME_BUILD_ID__: string | undefined;
declare const __KERBEROSEC_CORE_RUNTIME_BUILD_EPOCH_MS__: number | undefined;

const HUB_DISCOVERY_ENV = "KERBEROSEC_HUB_DISCOVERY_PATH";
const HUB_BUILD_ID_ENV = "KERBEROSEC_HUB_BUILD_ID";
const HUB_BUILD_EPOCH_ENV = "KERBEROSEC_HUB_BUILD_EPOCH_MS";
...
export function resolveHubBuildId(): string {
	...
	const embedded =
		typeof __KERBEROSEC_CORE_RUNTIME_BUILD_ID__ === "string"
			? __KERBEROSEC_CORE_RUNTIME_BUILD_ID__.trim()
			: "";
...
export function resolveHubBuildEpochMs(): number | undefined {
	...
	return typeof __KERBEROSEC_CORE_RUNTIME_BUILD_EPOCH_MS__ === "number" &&
		Number.isFinite(__KERBEROSEC_CORE_RUNTIME_BUILD_EPOCH_MS__)
		? __KERBEROSEC_CORE_RUNTIME_BUILD_EPOCH_MS__
		: undefined;
}
...
/**
 * Compatibility for a managed local Hub discovered through KerberoSec's owner
...
export { resolveKerberoSecDataDir, resolveKerberoSecDir };
