...
describe("syncTelemetrySettingFromSharedGlobalSettings", () => {
	...
	beforeEach(() => {
		previousSettingsPath = process.env.KERBEROSEC_GLOBAL_SETTINGS_PATH
		tempDir = mkdtempSync(join(tmpdir(), "kerberosec-vscode-telemetry-sync-"))
	...
	afterEach(() => {
		if (previousSettingsPath === undefined) {
			...
			process.env.KERBEROSEC_GLOBAL_SETTINGS_PATH = previousSettingsPath
		}
