...
export interface EffectiveProviderConfig {
	...
	/**
	 * OAuth-style auth bundle (e.g. kerberosec provider's WorkOS token).
 ...
 * Mirrors `ProviderUsageCostDisplay` from `@kerberosec/llms` and the CLI's
 ...
 * user's subscription (e.g. KerberoSecPass, ChatGPT Plus/Pro).
 */
