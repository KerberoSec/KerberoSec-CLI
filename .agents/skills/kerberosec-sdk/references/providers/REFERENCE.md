...
The KerberoSec SDK supports every major LLM provider out of the box via `@kerberosec/llms`.
...
```typescript
import { createGateway, DefaultGateway } from "@kerberosec/llms"
...
```typescript
import { getModelsForProvider } from "@kerberosec/llms"
...
// Via KerberoSecCore accumulated usage
...
- `../kerberoseccore/REFERENCE.md` - Using providers with KerberoSecCore
