...
export interface KerberoSecTelemetryServiceConfig
...
export function createKerberoSecTelemetryServiceMetadata(
...
export function createKerberoSecTelemetryServiceConfig(
	configOverrides: Partial<KerberoSecTelemetryServiceConfig> = {},
): KerberoSecTelemetryServiceConfig {
	return {
		...getTelemetryBuildTimeConfig(),
		...configOverrides,
		metadata: createKerberoSecTelemetryServiceMetadata(
			configOverrides.metadata,
		),
	};
}
