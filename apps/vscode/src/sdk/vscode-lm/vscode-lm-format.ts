// Converts KerberoSec SDK messages (@kerberosec/llms `Message`) into VS Code Language
...
import type { ContentBlock, Message } from "@kerberosec/llms"
...
export function asObjectSafe(value: unknown): object {
	...
	try {
		...
		Logger.warn("KerberoSec <Language Model API>: Failed to parse object:", error)
		return {}
	}
}
