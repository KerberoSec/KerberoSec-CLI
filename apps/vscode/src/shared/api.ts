import type { ModelModalities, ModelOperation, ModelOperationMode } from "@kerberosec/shared"
import { ApiFormat } from "./proto/kerberosec/models"
...
export const kerberosecPassDefaultModelId = "kerberosec-pass/glm-5.2"
export const kerberosecPassModelInfoSaneDefaults: ModelInfo = {
	maxTokens: 8_192,
...
export function resolveKerberoSecPassModelInfo(modelId: string, modelInfoByName?: Record<string, ModelInfo>): ModelInfo {
	return modelInfoByName?.[getModelSlug(modelId)] ?? kerberosecPassModelInfoSaneDefaults
}
...
//
// The Codex catalog and default model id are sourced from the `@kerberosec/llms`
// SDK.
// Azure OpenAI
