...
import type { KerberoSecAccountUserInfo } from "../../../auth/AuthService"
...
export class OpenTelemetryTelemetryProvider implements ITelemetryProvider {
	...
	constructor(
		...
		if (meterProvider) {
			this.meter = meterProvider.getMeter("kerberosec")
			this.meterProvider = meterProvider
		}

		if (loggerProvider) {
			this.logger = loggerProvider.getLogger("kerberosec")
	...
	public identifyUser(userInfo: KerberoSecAccountUserInfo, properties: TelemetryProperties = {}): void {
	 ...
	 */
	private buildUserAttributes(userInfo: KerberoSecAccountUserInfo, properties: TelemetryProperties = {}): Record<string, string> {
