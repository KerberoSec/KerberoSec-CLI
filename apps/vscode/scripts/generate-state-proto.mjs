 ...
 *
 * The generated proto content is written to proto/kerberosec/state.proto,
...
const STATE_PROTO_PATH = "proto/kerberosec/state.proto"
...
function parseSecretsKeys(sourceFile) {
	...
	for (const element of initializer.getElements()) {
		...
		// Skip prefixed keys like "kerberosec:kerberosecAccountId"
		if (!key.includes(":")) {
			keys.push(key)
		}
	}
