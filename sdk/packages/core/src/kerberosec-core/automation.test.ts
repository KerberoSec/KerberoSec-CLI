...
import { createKerberoSecCoreAutomationRuntimeHandlers } from "./automation";
...
describe("createKerberoSecCoreAutomationRuntimeHandlers", () => {
	it("starts every scheduled run with automation provenance", async () => {
		...
		const handlers = createKerberoSecCoreAutomationRuntimeHandlers({
