 ...
 * hard failures on openrouter, kerberosec, and generic OpenAI-compatible
 ...
 * turn, which must never be retried because KerberoSec runs its own tool loop).
 */
...
describe("openai-compatible wire format (openrouter / kerberosec / custom endpoints)", () => {
