...
/**
 * KerberoSecLogoSanta component renders the KerberoSec logo with a festive Santa hat
 ...
 * the same theme and environment color system as KerberoSecLogoVariable.
 *
 * @param {SVGProps<SVGSVGElement> & { environment?: Environment }} props - Standard SVG props plus optional environment
 * @returns {JSX.Element} SVG KerberoSec logo with Santa hat that adapts to VS Code themes and environment
 */
const KerberoSecLogoSanta = (props: SVGProps<SVGSVGElement> & { environment?: Environment }) => {
	...
	return (
		<svg height="50" viewBox="0 0 66.62 63.92" width="47" xmlns="http://www.w3.org/2000/svg" {...svgProps}>
			{/* Original KerberoSec robot logo */}
			<path
...
export default KerberoSecLogoSanta
