import { CreateHookRequest, CreateSkillRequest, RuleFileRequest } from "@shared/proto/index.kerberosec"
					...
					{ruleType === "hook" ? (
						<>
							...
							<span className="sr-only" id="hook-select-description">
								Choose a hook type to create. Hooks execute at specific points in KerberoSec's lifecycle. Available:{" "}
