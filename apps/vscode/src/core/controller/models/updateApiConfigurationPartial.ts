...
import { UpdateApiConfigurationPartialRequest } from "@shared/proto/kerberosec/models"
...
export async function updateApiConfigurationPartial(
	...
	try {
		...
		clearOrganizationForKerberoSecPassProviderSelection(controller, normalizedConfig)
		if (controller.task) {
