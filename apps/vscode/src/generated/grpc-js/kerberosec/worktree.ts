...
//   protoc               v3.19.1
// source: kerberosec/worktree.proto
...
export interface WorktreeDefaults {
  /** Auto-generated branch name like "worktree/kerberosec-abc12" */
  suggestedBranch: string;
  /** Path in Documents/KerberoSec/Worktrees/<project>-<suffix> */
...
export const WorktreeServiceDefinition = {
  ...
  fullName: "kerberosec.WorktreeService",
  methods: {
...
export const WorktreeServiceService = {
  /** Lists all worktrees in the current repository */
  listWorktrees: {
    path: "/kerberosec.WorktreeService/listWorktrees" as const,
  ...
  /** Creates a new worktree */
  createWorktree: {
    path: "/kerberosec.WorktreeService/createWorktree" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Deletes an existing worktree */
  deleteWorktree: {
    path: "/kerberosec.WorktreeService/deleteWorktree" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Switches to a different worktree (opens in VS Code) */
  switchWorktree: {
    path: "/kerberosec.WorktreeService/switchWorktree" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Gets available branches for creating worktrees */
  getAvailableBranches: {
    path: "/kerberosec.WorktreeService/getAvailableBranches" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
  ...
  /** Gets suggested defaults for creating a new worktree (auto-generated branch name and path) */
  getWorktreeDefaults: {
    path: "/kerberosec.WorktreeService/getWorktreeDefaults" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
  ...
  /** Gets the status of .worktreeinclude file and .gitignore contents for creating one */
  getWorktreeIncludeStatus: {
    path: "/kerberosec.WorktreeService/getWorktreeIncludeStatus" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: EmptyRequest): Buffer => Buffer.from(EmptyRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): EmptyRequest => EmptyRequest.decode(value),
  ...
  /** Creates a .worktreeinclude file with the provided content */
  createWorktreeInclude: {
    path: "/kerberosec.WorktreeService/createWorktreeInclude" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Switches to a different branch in the current worktree (git checkout) */
  checkoutBranch: {
    path: "/kerberosec.WorktreeService/checkoutBranch" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Merges a worktree's branch into the target branch and optionally deletes the worktree */
  mergeWorktree: {
    path: "/kerberosec.WorktreeService/mergeWorktree" as const,
    requestStream: false as const,
    responseStream: false as const,
  ...
  /** Tracks when the worktrees view is opened (for telemetry) */
  trackWorktreeViewOpened: {
    path: "/kerberosec.WorktreeService/trackWorktreeViewOpened" as const,
    requestStream: false as const,
    responseStream: false as const,
