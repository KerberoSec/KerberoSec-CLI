...
<Tip>
API keys are stored locally in VS Code and are only used by the KerberoSec extension.
</Tip>
</Accordion>
...
Send a test message in KerberoSec to verify your connection works correctly with the LiteLLM proxy.
...
Confirm you're signed into the correct KerberoSec organization. Verify your administrator has saved the LiteLLM configuration and that you have the latest version of the KerberoSec extension.
...
- Regularly update the KerberoSec extension for security patches
