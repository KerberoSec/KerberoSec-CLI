...
const CheckpointsServiceHandlers: serviceTypes.CheckpointsServiceHandlers = {
    ...
    checkpointViewLatestChanges: checkpointViewLatestChanges,
    checkpointLatestChangesCount: checkpointLatestChangesCount,
} 

const CommandsServiceHandlers: serviceTypes.CommandsServiceHandlers = {
    addToKerberoSec: addToKerberoSec,
    fixWithKerberoSec: fixWithKerberoSec,
    explainWithKerberoSec: explainWithKerberoSec,
    improveWithKerberoSec: improveWithKerberoSec,
} 
...
const FileServiceHandlers: serviceTypes.FileServiceHandlers = {
    ...
    toggleKerberoSecRule: toggleKerberoSecRule,
...
const ModelsServiceHandlers: serviceTypes.ModelsServiceHandlers = {
    ...
    refreshKerberoSecRecommendedModelsRpc: refreshKerberoSecRecommendedModelsRpc,
...
const StateServiceHandlers: serviceTypes.StateServiceHandlers = {
    ...
    installKerberoSecCli: installKerberoSecCli,
...
const TaskServiceHandlers: serviceTypes.TaskServiceHandlers = {
    ...
    proceedWhileRunningCommand: proceedWhileRunningCommand,
    clearTask: clearTask,
...
export const serviceHandlers: Record<string, any> = {
    "kerberosec.AccountService": AccountServiceHandlers,
    "kerberosec.BrowserService": BrowserServiceHandlers,
    "kerberosec.CheckpointsService": CheckpointsServiceHandlers,
    "kerberosec.CommandsService": CommandsServiceHandlers,
    "kerberosec.FileService": FileServiceHandlers,
    "kerberosec.MarketplaceService": MarketplaceServiceHandlers,
    "kerberosec.McpService": McpServiceHandlers,
    "kerberosec.ModelsService": ModelsServiceHandlers,
    "kerberosec.OcaAccountService": OcaAccountServiceHandlers,
    "kerberosec.RemoteConfigService": RemoteConfigServiceHandlers,
    "kerberosec.SlashService": SlashServiceHandlers,
    "kerberosec.StateService": StateServiceHandlers,
    "kerberosec.TaskService": TaskServiceHandlers,
    "kerberosec.UiService": UiServiceHandlers,
    "kerberosec.WebService": WebServiceHandlers,
    "kerberosec.WorktreeService": WorktreeServiceHandlers,
}
...
export const responseStreamingMethods: ReadonlySet<string> = new Set([
    "kerberosec.AccountService.subscribeToAuthStatusUpdate",
    "kerberosec.McpService.subscribeToMcpServers",
    "kerberosec.ModelsService.subscribeToOpenRouterModels",
    "kerberosec.ModelsService.subscribeToLiteLlmModels",
    "kerberosec.OcaAccountService.ocaSubscribeToAuthStatusUpdate",
    "kerberosec.StateService.subscribeToState",
    "kerberosec.UiService.subscribeToAddToInput",
    "kerberosec.UiService.subscribeToMcpButtonClicked",
    "kerberosec.UiService.subscribeToMarketplaceButtonClicked",
    "kerberosec.UiService.subscribeToHistoryButtonClicked",
    "kerberosec.UiService.subscribeToChatButtonClicked",
    "kerberosec.UiService.subscribeToAccountButtonClicked",
    "kerberosec.UiService.subscribeToSettingsButtonClicked",
    "kerberosec.UiService.subscribeToWorktreesButtonClicked",
    "kerberosec.UiService.subscribeToPartialMessage",
    "kerberosec.UiService.subscribeToRelinquishControl",
    "kerberosec.UiService.subscribeToShowWebview",
])
