...
/**
 * Combines API request start and finish messages in an array of KerberoSecMessages.
 *
 ...
 * @returns A new array of KerberoSecMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: KerberoSecMessage[]): KerberoSecMessage[] {
	const combinedApiRequests: KerberoSecMessage[] = []
