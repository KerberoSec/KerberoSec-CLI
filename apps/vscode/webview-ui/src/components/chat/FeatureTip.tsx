...
const FEATURE_TIPS: FeatureTipItem[] = [
	{
		text: "Add a .kerberosecrules file to your project root to give KerberoSec project-specific instructions.",
	},
	{
		text: "Switch to Plan Mode to discuss and plan an approach before KerberoSec takes action.",
	},
	{
		text: "Use @ in the chat input to add files, folders, or URLs as context for your task.",
	},
	{
		text: "Set up MCP Servers to give KerberoSec access to external tools and APIs.",
	},
	{
		text: "KerberoSec creates checkpoints after changes — you can always restore to a previous state.",
	},
	{
	...
	{
		text: "Use the quote button to select text from KerberoSec's response and reference it in your reply.",
	},
	{
		text: "You can drag and drop images into the chat to share screenshots with KerberoSec.",
	},
	{
 ...
 * Appears after a brief delay and cycles through tips while KerberoSec is thinking.
 */
