import { KerberoSecRulesToggles, RuleScope, ToggleWorkflowRequest } from "@shared/proto/kerberosec/file"
 ...
 */
export async function toggleWorkflow(controller: Controller, request: ToggleWorkflowRequest): Promise<KerberoSecRulesToggles> {
	...
	return KerberoSecRulesToggles.create({ toggles: toggles })
}
