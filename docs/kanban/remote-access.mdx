...
```bash
KANBAN_RUNTIME_HOST=0.0.0.0 kerberosec
```

When you run `kerberosec`, it will launch Kanban bound to `0.0.0.0`.
...
export class KanbanEc2Stack extends cdk.Stack {
    constructor(scope: Construct, id: string, props?: cdk.StackProps) {
        ...
        userData.addCommands(
            ...
            "git clone -b main https://github.com/kerberosec/kanban.git /opt/kanban",
