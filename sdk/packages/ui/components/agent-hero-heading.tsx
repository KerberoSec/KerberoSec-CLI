...
export function AgentHeroHeading() {
	...
	return (
		<h1
			...
			className="kerberosec-ui-agent-hero-heading"
		>
			<span aria-hidden="true">
				What would you like to{" "}
				<span className="kerberosec-ui-agent-hero-heading__word" key={verb}>
					{verb.split("").map((character, index) => (
						<span
							className="kerberosec-ui-agent-hero-heading__character"
