...
describe("chat workspace", () => {
	...
	beforeEach(async () => {
		previousDataDir = process.env.KERBEROSEC_DATA_DIR;
	...
	it("creates the shared chat workspace under the kerberosec data directory", async () => {
	...
	it("recognizes the default data-dir layout as the chat workspace", () => {
		expect(
			isChatWorkspacePath("/home/user/.kerberosec/data/workspaces/chat"),
		).toBe(true);
		expect(
			isChatWorkspacePath("/home/user/.kerberosec/data/workspaces/chat/my-app"),
		).toBe(false);
	});
