...
export interface ThinkingLoaderInputs {
	...
	/** Tail of the raw kerberosecMessages array. */
	lastRawMessage: KerberoSecMessage | undefined
	groupedMessages: (KerberoSecMessage | KerberoSecMessage[])[]
	/** Tail of groupedMessages. */
	lastVisibleRow: KerberoSecMessage | KerberoSecMessage[] | undefined
	/** Tail message of lastVisibleRow (last element when it is a group). */
	lastVisibleMessage: KerberoSecMessage | undefined
