...
export function DisclosureContent({
	...
	return (
		<div
			aria-hidden={!isOpen}
			className="kerberosec-chat-disclosure-content-motion"
			data-state={isOpen ? "open" : "closed"}
			id={panelId}
			inert={inert as boolean | undefined}
		>
			<div className="kerberosec-chat-disclosure-content-motion-inner">
				{shouldRenderContent ? (
					<div
						{...props}
						className={classNames(
							contentClassName,
							presentation === "rail" && "kerberosec-chat-panel-rail",
							className,
						)}
					/>
				) : null}
