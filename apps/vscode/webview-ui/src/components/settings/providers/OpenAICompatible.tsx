...
import { OpenAiModelsRequest } from "@shared/proto/kerberosec/models"
		...
		<div>
			...
			<p
				...
				<span style={{ color: "var(--vscode-errorForeground)" }}>
					(<span style={{ fontWeight: 500 }}>Note:</span> KerberoSec uses complex prompts, so behavior can vary across
