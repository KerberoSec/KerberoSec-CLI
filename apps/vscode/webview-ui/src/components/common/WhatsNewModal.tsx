import { BannerAction, BannerCardData } from "@shared/kerberosec/banner"
					...
					<div className="flex flex-col items-center gap-3 mt-4 pt-4 border-t border-[var(--vscode-widget-border)]">
						...
						<div className="flex items-center gap-4">
							...
							<a
								...
								className="text-[var(--vscode-foreground)] hover:text-[var(--vscode-textLink-activeForeground)] transition-colors"
								href="https://discord.gg/kerberosec"
								rel="noopener noreferrer"
								target="_blank">
								<DiscordIcon />
							</a>
							...
							<a
								...
								className="text-[var(--vscode-foreground)] hover:text-[var(--vscode-textLink-activeForeground)] transition-colors"
								href="https://github.com/kerberosec/kerberosec"
								rel="noopener noreferrer"
								target="_blank">
								<GitHubIcon />
							</a>
							...
							<a
								...
								className="text-[var(--vscode-foreground)] hover:text-[var(--vscode-textLink-activeForeground)] transition-colors"
								href="https://www.reddit.com/r/kerberosec/"
								rel="noopener noreferrer"
								target="_blank">
								<RedditIcon />
							</a>
							...
							<a
								...
								className="text-[var(--vscode-foreground)] hover:text-[var(--vscode-textLink-activeForeground)] transition-colors"
								href="https://www.linkedin.com/company/kerberosecbot/"
								rel="noopener noreferrer"
								target="_blank">
								<LinkedInIcon />
							</a>
