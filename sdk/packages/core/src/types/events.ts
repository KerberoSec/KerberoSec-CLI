...
export interface SessionTeamProgressEvent {
	sessionId: string;
	teamName: string;
	lifecycle: import("@kerberosec/shared").TeamProgressLifecycleEvent;
	summary: import("@kerberosec/shared").TeamProgressSummary;
}
...
export type CoreSessionEvent =
	...
	| {
			...
			payload: {
				sessionId: string;
				event: import("@kerberosec/shared").AgentEvent;
