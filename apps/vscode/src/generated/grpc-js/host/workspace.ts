...
import { FileDiagnostics, Metadata as Metadata1 } from "../kerberosec/common";

export interface GetWorkspacePathsRequest {
  /**
   * The unique ID for the workspace/project.
   * This is currently optional in vscode. It is required in other environments where kerberosec is running at
...
export interface OpenKerberoSecSidebarPanelRequest {
}

export interface OpenKerberoSecSidebarPanelResponse {
}
...
function createBaseOpenKerberoSecSidebarPanelRequest(): OpenKerberoSecSidebarPanelRequest {
  return {};
}

export const OpenKerberoSecSidebarPanelRequest: MessageFns<OpenKerberoSecSidebarPanelRequest> = {
  encode(_: OpenKerberoSecSidebarPanelRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): OpenKerberoSecSidebarPanelRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseOpenKerberoSecSidebarPanelRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
      }
  ...
  fromJSON(_: any): OpenKerberoSecSidebarPanelRequest {
    return {};
  },

  toJSON(_: OpenKerberoSecSidebarPanelRequest): unknown {
    const obj: any = {};
    return obj;
  },

  create<I extends Exact<DeepPartial<OpenKerberoSecSidebarPanelRequest>, I>>(
    base?: I,
  ): OpenKerberoSecSidebarPanelRequest {
    return OpenKerberoSecSidebarPanelRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OpenKerberoSecSidebarPanelRequest>, I>>(
    _: I,
  ): OpenKerberoSecSidebarPanelRequest {
    const message = createBaseOpenKerberoSecSidebarPanelRequest();
    return message;
...
function createBaseOpenKerberoSecSidebarPanelResponse(): OpenKerberoSecSidebarPanelResponse {
  return {};
}

export const OpenKerberoSecSidebarPanelResponse: MessageFns<OpenKerberoSecSidebarPanelResponse> = {
  encode(_: OpenKerberoSecSidebarPanelResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): OpenKerberoSecSidebarPanelResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseOpenKerberoSecSidebarPanelResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
      }
  ...
  fromJSON(_: any): OpenKerberoSecSidebarPanelResponse {
    return {};
  },

  toJSON(_: OpenKerberoSecSidebarPanelResponse): unknown {
    const obj: any = {};
    return obj;
  },

  create<I extends Exact<DeepPartial<OpenKerberoSecSidebarPanelResponse>, I>>(
    base?: I,
  ): OpenKerberoSecSidebarPanelResponse {
    return OpenKerberoSecSidebarPanelResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OpenKerberoSecSidebarPanelResponse>, I>>(
    _: I,
  ): OpenKerberoSecSidebarPanelResponse {
    const message = createBaseOpenKerberoSecSidebarPanelResponse();
    return message;
...
export const WorkspaceServiceDefinition = {
  ...
  methods: {
    ...
    /** Opens and focuses the KerberoSec sidebar panel in the host IDE. */
    openKerberoSecSidebarPanel: {
      name: "openKerberoSecSidebarPanel",
      requestType: OpenKerberoSecSidebarPanelRequest as typeof OpenKerberoSecSidebarPanelRequest,
      requestStream: false,
      responseType: OpenKerberoSecSidebarPanelResponse as typeof OpenKerberoSecSidebarPanelResponse,
      responseStream: false,
      options: {},
    },
...
export const WorkspaceServiceService = {
  ...
  /** Opens and focuses the KerberoSec sidebar panel in the host IDE. */
  openKerberoSecSidebarPanel: {
    path: "/host.WorkspaceService/openKerberoSecSidebarPanel" as const,
    requestStream: false as const,
    responseStream: false as const,
    requestSerialize: (value: OpenKerberoSecSidebarPanelRequest): Buffer =>
      Buffer.from(OpenKerberoSecSidebarPanelRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): OpenKerberoSecSidebarPanelRequest =>
      OpenKerberoSecSidebarPanelRequest.decode(value),
    responseSerialize: (value: OpenKerberoSecSidebarPanelResponse): Buffer =>
      Buffer.from(OpenKerberoSecSidebarPanelResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): OpenKerberoSecSidebarPanelResponse =>
      OpenKerberoSecSidebarPanelResponse.decode(value),
  },
  /** Opens and focuses the terminal panel. */
  openTerminalPanel: {
...
export interface WorkspaceServiceServer extends UntypedServiceImplementation {
  ...
  /** Opens and focuses the KerberoSec sidebar panel in the host IDE. */
  openKerberoSecSidebarPanel: handleUnaryCall<OpenKerberoSecSidebarPanelRequest, OpenKerberoSecSidebarPanelResponse>;
  /** Opens and focuses the terminal panel. */
...
export interface WorkspaceServiceClient extends Client {
  ...
  /** Opens and focuses the KerberoSec sidebar panel in the host IDE. */
  openKerberoSecSidebarPanel(
    request: OpenKerberoSecSidebarPanelRequest,
    callback: (error: ServiceError | null, response: OpenKerberoSecSidebarPanelResponse) => void,
  ): ClientUnaryCall;
  openKerberoSecSidebarPanel(
    request: OpenKerberoSecSidebarPanelRequest,
    metadata: Metadata,
