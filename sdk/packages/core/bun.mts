...
const minify = Bun.env.KERBEROSEC_SOURCEMAPS !== "1";
...
const buildConfig = {
	...
	external,
	define: {
		__KERBEROSEC_CORE_RUNTIME_BUILD_ID__: JSON.stringify(runtimeBuildId),
		...
		__KERBEROSEC_CORE_RUNTIME_BUILD_EPOCH_MS__: JSON.stringify(Date.now()),
	},
} as const;
