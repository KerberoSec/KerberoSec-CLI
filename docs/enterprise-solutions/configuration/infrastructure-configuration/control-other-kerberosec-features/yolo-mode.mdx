...
YOLO Mode enables KerberoSec to operate with complete autonomy, auto-approving all actions without user confirmation. For Enterprise administrators, this page covers how to control access to YOLO Mode across your organization.
...
When YOLO Mode is enabled, KerberoSec automatically approves all operations including file changes, terminal commands, browser actions, and mode transitions. This provides maximum automation speed but removes all safety guardrails.
...
- Users can enable or disable YOLO Mode in their local KerberoSec settings
...
- Persists across KerberoSec restarts
...
- Join our [Discord](https://discord.gg/kerberosec) for community discussion
